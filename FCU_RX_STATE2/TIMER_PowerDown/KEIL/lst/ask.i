...
void PB14Toggle(){
    if((*((volatile uint32_t *)(((((( uint32_t)0x50000000) + 0x4000) + 0x0200)+(0x40*(1))) + ((14)<<2)))))
...
void DataPacketStart(uint8_t header){
    ...
    AskStart = 1;
		((TIMER_T *) ((( uint32_t)0x40000000) + 0x10000))->TCSR = 0x6A000000;
    return;

}

void MyDelay(int count){
		int timeTMP=((TIMER_T *) ((( uint32_t)0x40000000) + 0x10000))->TDR;
	
		while(((TIMER_T *) ((( uint32_t)0x40000000) + 0x10000))->TDR < timeTMP + count){
