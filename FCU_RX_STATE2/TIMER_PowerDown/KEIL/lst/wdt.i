...
#line 13 "..\\..\\..\\..\\Library\\StdDriver\\src\\wdt.c"
...
{
    ((WDT_T *) ((( uint32_t)0x40000000) + 0x4000))->WTCRALT = u32ResetDelay;

    ((WDT_T *) ((( uint32_t)0x40000000) + 0x4000))->WTCR = u32TimeoutInterval | (1ul << 7) |
                (u32EnableReset << 1) |
                (u32EnableWakeup << 4);
    return;
}
