...
#line 12 "..\\..\\..\\..\\Library\\StdDriver\\src\\clk.c"
...
void CLK_EnableCKO(uint32_t u32ClkSrc, uint32_t u32ClkDiv, uint32_t u32ClkDivBy1En)
{
    ...
    ((CLK_T *) ((( uint32_t)0x50000000) + 0x00200))->APBCLK |= (1ul << 6);

     
    ((CLK_T *) ((( uint32_t)0x50000000) + 0x00200))->CLKSEL2 = (((CLK_T *) ((( uint32_t)0x50000000) + 0x00200))->CLKSEL2 & (~(3ul << 2))) | (u32ClkSrc);
...
void CLK_SetHCLK(uint32_t u32ClkSrc, uint32_t u32ClkDiv)
{
    ...
    if(u32HIRCSTB == 0)
        ((CLK_T *) ((( uint32_t)0x50000000) + 0x00200))->PWRCON &= ~(1ul << 4);
}
