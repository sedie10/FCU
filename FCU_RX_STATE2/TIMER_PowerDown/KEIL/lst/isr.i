...
void GPAB_IRQHandler(void){
    ...
    if(((((GPIO_T *) (((( uint32_t)0x50000000) + 0x4000) + 0x0040)))->ISRC & (0x00000008))){
        ...
        if(!FskCnt){
					...
					FskStartCnt = ((TIMER_T *) ((( uint32_t)0x40000000) + 0x10000))->TDR;
				}
        ...
        if(FskCnt == 256){
						...
						FskEndCnt = ((TIMER_T *) ((( uint32_t)0x40000000) + 0x10000))->TDR;
        ...
        ((((GPIO_T *) (((( uint32_t)0x50000000) + 0x4000) + 0x0040)))->ISRC = (0x00000008));
...
void UART02_IRQHandler(void){
	...
	int b;
	uint8_t dat = 0xFF;
	uint32_t intsts = ((UART_T *) ((( uint32_t)0x40100000) + 0x54000))->ISR;
	
	if(intsts & (1ul << 8)){
		printf("\r\nB : ");
			
        while((((((UART_T *) ((( uint32_t)0x40100000) + 0x54000)))->ISR & (1ul << 0))>>0)){
                dat = ((((UART_T *) ((( uint32_t)0x40100000) + 0x54000)))->RBR);
