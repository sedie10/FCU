...
#line 12 "..\\..\\..\\..\\Library\\StdDriver\\src\\sys.c"
...
void SYS_ClearResetSrc(uint32_t u32Src)
{
    ((GCR_T *) ((( uint32_t)0x50000000) + 0x00000))->RSTSRC |= u32Src;
}
...
uint32_t SYS_GetBODStatus(void)
{
    return (((GCR_T *) ((( uint32_t)0x50000000) + 0x00000))->BODCR & (1ul << 6)) ? 1 : 0;
}
...
uint32_t SYS_GetResetSrc(void)
{
    return (((GCR_T *) ((( uint32_t)0x50000000) + 0x00000))->RSTSRC);
}
...
uint32_t SYS_IsRegLocked(void)
{
    return !(((GCR_T *) ((( uint32_t)0x50000000) + 0x00000))->REGWRPROT & (1ul << 0));
}
...
void SYS_ResetChip(void)
{
    ((GCR_T *) ((( uint32_t)0x50000000) + 0x00000))->IPRSTC1 |= (1ul << 0);
}
...
void SYS_ResetCPU(void)
{
    ((GCR_T *) ((( uint32_t)0x50000000) + 0x00000))->IPRSTC1 |= (1ul << 1);
}
...
void SYS_ResetModule(uint32_t u32ModuleIndex)
{
    ...
    *(volatile uint32_t *)((uint32_t)&((GCR_T *) ((( uint32_t)0x50000000) + 0x00000))->IPRSTC1 + (u32ModuleIndex >> 24))  |= 1 << (u32ModuleIndex & 0x00ffffff);
...
void SYS_EnableBOD(int32_t i32Mode, uint32_t u32BODLevel)
{
    ((GCR_T *) ((( uint32_t)0x50000000) + 0x00000))->BODCR |= (1ul << 0);
    ((GCR_T *) ((( uint32_t)0x50000000) + 0x00000))->BODCR = (((GCR_T *) ((( uint32_t)0x50000000) + 0x00000))->BODCR & ~(1ul << 3)) | i32Mode;
    ((GCR_T *) ((( uint32_t)0x50000000) + 0x00000))->BODCR = (((GCR_T *) ((( uint32_t)0x50000000) + 0x00000))->BODCR & ~(3ul << 1)) | u32BODLevel;
}
