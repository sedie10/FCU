...
#line 11 "..\\..\\..\\..\\Library\\StdDriver\\src\\spi.c"
                  ...
                  uint32_t u32BusClock)
{
    ...
    spi->CNTRL = u32MasterSlave | (u32DataWidth << 3) | (u32SPIMode);
    ...
    if(u32MasterSlave == (0x0))
    {
         
        spi->SSR = (0x0);

         
        if(spi == ((SPI_T *) ((( uint32_t)0x40000000) + 0x30000)))
        {
            if((((CLK_T *) ((( uint32_t)0x50000000) + 0x00200))->CLKSEL1 & (1ul << 4)) == (0x1UL<<4))
        ...
        {
            if((((CLK_T *) ((( uint32_t)0x50000000) + 0x00200))->CLKSEL1 & (1ul << 5)) == (0x1UL<<5))
                u32ClkSrc = u32HCLKFreq;
            else
                u32ClkSrc = CLK_GetPLLClockFreq();
        }
        ...
        if(u32BusClock >= u32HCLKFreq)
        {
            ...
            if(spi == ((SPI_T *) ((( uint32_t)0x40000000) + 0x30000)))
                ((CLK_T *) ((( uint32_t)0x50000000) + 0x00200))->CLKSEL1 = (((CLK_T *) ((( uint32_t)0x50000000) + 0x00200))->CLKSEL1 & (~(1ul << 4))) | (0x1UL<<4);
            else
                ((CLK_T *) ((( uint32_t)0x50000000) + 0x00200))->CLKSEL1 = (((CLK_T *) ((( uint32_t)0x50000000) + 0x00200))->CLKSEL1 & (~(1ul << 5))) | (0x1UL<<5);
        ...
        else if(u32BusClock == 0)
        {
            ...
            spi->DIVIDER = (spi->DIVIDER & (~(0xFFul << 0))) | (0xFF << 0);
             
            return (u32ClkSrc / ((0xFF + 1) * 2));
        }
        else
        {
            u32Div = (((u32ClkSrc * 10) / u32BusClock + 5) / 10) - 1;  
            if(u32Div > 0xFF)
            {
                 
                spi->CNTRL2 &= (~(1ul << 31));
                u32Div = (((u32ClkSrc * 10) / (u32BusClock * 2) + 5) / 10) - 1;  
                if(u32Div > 0xFF)
                    u32Div = 0xFF;
                spi->DIVIDER = (spi->DIVIDER & (~(0xFFul << 0))) | (u32Div << 0);
...
void SPI_Close(SPI_T *spi)
{
    if(spi == ((SPI_T *) ((( uint32_t)0x40000000) + 0x30000)))
    {
        ...
        ((GCR_T *) ((( uint32_t)0x50000000) + 0x00000))->IPRSTC2 |= (1ul << 12);
        ((GCR_T *) ((( uint32_t)0x50000000) + 0x00000))->IPRSTC2 &= ~(1ul << 12);
    }
    else
    {
         
        ((GCR_T *) ((( uint32_t)0x50000000) + 0x00000))->IPRSTC2 |= (1ul << 13);
        ((GCR_T *) ((( uint32_t)0x50000000) + 0x00000))->IPRSTC2 &= ~(1ul << 13);
    }
}
...
void SPI_EnableAutoSS(SPI_T *spi, uint32_t u32SSPinMask, uint32_t u32ActiveLevel)
{
    spi->SSR = (spi->SSR & (~((1ul << 3) | (1ul << 2) | (1ul << 0)))) | (u32SSPinMask | u32ActiveLevel | (1ul << 3));
}
...
void SPI_EnableFIFO(SPI_T *spi, uint32_t u32TxThreshold, uint32_t u32RxThreshold)
{
    spi->FIFO_CTL = (spi->FIFO_CTL & ~((7ul << 28) | (7ul << 24))) |
                    ((u32TxThreshold << 28) |
                     (u32RxThreshold << 24));
...
void SPI_EnableInt(SPI_T *spi, uint32_t u32Mask)
{
    ...
    if((u32Mask & (0x02)) == (0x02))
        spi->CNTRL2 |= (1ul << 10);

     
    if((u32Mask & (0x04)) == (0x04))
        spi->FIFO_CTL |= (1ul << 3);

     
    if((u32Mask & (0x08)) == (0x08))
        spi->FIFO_CTL |= (1ul << 2);

     
    if((u32Mask & (0x10)) == (0x10))
        spi->FIFO_CTL |= (1ul << 6);

     
    if((u32Mask & (0x20)) == (0x20))
        spi->FIFO_CTL |= (1ul << 21);
}
...
uint32_t SPI_GetIntFlag(SPI_T *spi, uint32_t u32Mask)
{
    ...
    if((u32Mask & (0x01)) && (spi->CNTRL & (1ul << 16)))
        u32IntFlag |= (0x01);

     
    if((u32Mask & (0x02)) && (spi->CNTRL2 & (1ul << 11)))
        u32IntFlag |= (0x02);

     
    if((u32Mask & (0x04)) && (spi->STATUS & (1ul << 4)))
        u32IntFlag |= (0x04);

     
    if((u32Mask & (0x08)) && (spi->STATUS & (1ul << 0)))
        u32IntFlag |= (0x08);

     
    if((u32Mask & (0x10)) && (spi->STATUS & (1ul << 2)))
        u32IntFlag |= (0x10);

     
    if((u32Mask & (0x20)) && (spi->STATUS & (1ul << 20)))
        u32IntFlag |= (0x20);
...
uint32_t SPI_GetStatus(SPI_T *spi, uint32_t u32Mask)
{
    ...
    if((u32Mask & (0x01)) && (spi->CNTRL & (1ul << 0)))
        u32Flag |= (0x01);

     
    if((u32Mask & (0x02)) && (spi->CNTRL & (1ul << 24)))
        u32Flag |= (0x02);

     
    if((u32Mask & (0x04)) && (spi->CNTRL & (1ul << 25)))
        u32Flag |= (0x04);

     
    if((u32Mask & (0x08)) && (spi->CNTRL & (1ul << 26)))
        u32Flag |= (0x08);

     
    if((u32Mask & (0x10)) && (spi->CNTRL & (1ul << 27)))
        u32Flag |= (0x10);
