...
#line 13 "..\\..\\..\\..\\Library\\StdDriver\\src\\crc.c"
...
void CRC_Open(uint32_t u32Mode, uint32_t u32Attribute, uint32_t u32Seed, uint32_t u32DataLen)
{
    ...
    ((PDMA_GCR_T *) ((( uint32_t)0x50000000) + 0x08F00))->GCRCSR |= (1ul << 24);

    ((CRC_T *) ((( uint32_t)0x50000000) + 0x08E00))->SEED = u32Seed;
    ((CRC_T *) ((( uint32_t)0x50000000) + 0x08E00))->CTL = u32Mode | u32Attribute | u32DataLen | (1ul << 0);

     
    ((CRC_T *) ((( uint32_t)0x50000000) + 0x08E00))->CTL |= (1ul << 1);
}
...
void CRC_StartDMATransfer(uint32_t u32SrcAddr, uint32_t u32ByteCount)
{
    ((CRC_T *) ((( uint32_t)0x50000000) + 0x08E00))->DMASAR = u32SrcAddr;
    ((CRC_T *) ((( uint32_t)0x50000000) + 0x08E00))->DMABCR = u32ByteCount;
    ((CRC_T *) ((( uint32_t)0x50000000) + 0x08E00))->CTL |= (1ul << 23);
}
...
uint32_t CRC_GetChecksum(void)
{
    switch(((CRC_T *) ((( uint32_t)0x50000000) + 0x08E00))->CTL & (0x3ul << 30))
    {
        case 0x00000000UL:
        case 0x80000000UL:
            return (((CRC_T *) ((( uint32_t)0x50000000) + 0x08E00))->CHECKSUM & 0xFFFF);

        case 0xC0000000UL:
            return (((CRC_T *) ((( uint32_t)0x50000000) + 0x08E00))->CHECKSUM);

        case 0x40000000UL:
            return (((CRC_T *) ((( uint32_t)0x50000000) + 0x08E00))->CHECKSUM & 0xFF);
