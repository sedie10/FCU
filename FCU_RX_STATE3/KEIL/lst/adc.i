...
#line 13 "..\\..\\..\\..\\Library\\StdDriver\\src\\adc.c"
              ...
              uint32_t u32ChMask)
{
    ...
    (adc)->ADCR = ((adc)->ADCR & (~((1ul << 10) | (3ul << 2)))) |                 (u32InputMode) |                 (u32OpMode);



    (adc)->ADCHER  = ((adc)->ADCHER & ~((0xFFul << 0)|(0xFul << 10))) | ((u32ChMask) & (0xFFul << 0)) | (((u32ChMask) & ((0xFul << 10) >> 2)) << 2);
...
void ADC_EnableHWTrigger(ADC_T *adc,
                         ...
                         uint32_t u32Param)
{
    (adc)->ADCR &= ~((3ul << 4) | (3ul << 6) | (1ul << 8));

    (adc)->ADCR |= (u32Source) | (u32Param) | (1ul << 8);
