...
int main(void){
    ...
    ((GPIO_T *) (((( uint32_t)0x50000000) + 0x4000) )) -> PMD = (((GPIO_T *) (((( uint32_t)0x50000000) + 0x4000) + 0x0040)) -> PMD & ~(0x3 << 14)) | (0x1UL << 14);
    ((GPIO_T *) (((( uint32_t)0x50000000) + 0x4000) + 0x0040)) -> PMD = (((GPIO_T *) (((( uint32_t)0x50000000) + 0x4000) + 0x0040)) -> PMD & ~(0x3 << 26)) | (0x1UL << 26);
    ...
    TIMER_Open(((TIMER_T *) ((( uint32_t)0x40000000) + 0x10000)), (1UL << 27), 4000);
    ...
    UART0_Init();
	((((UART_T *) ((( uint32_t)0x40000000) + 0x50000)))->THR = ('0'));
    UART2_Init();

		
	printf("\r\ncounter1 : %d \r\n", ((TIMER_T *) ((( uint32_t)0x40000000) + 0x10000))->TDR);

     

    
    GPIO_SetMode(((GPIO_T *) (((( uint32_t)0x50000000) + 0x4000) + 0x0040)), 0x00000008, 0x0UL);
    GPIO_EnableInt(((GPIO_T *) (((( uint32_t)0x50000000) + 0x4000) + 0x0040)), 3, 0x00010000UL); 

    
    NVIC_EnableIRQ(GPAB_IRQn);


    GPIO_SetMode(((GPIO_T *) (((( uint32_t)0x50000000) + 0x4000) )), 0x00000200, 0x1UL); 
...
void SYS_Init1(void){
    ...
    ((GCR_T *) ((( uint32_t)0x50000000) + 0x00000))->GPB_MFP &= ~(1UL<<15);
    ((GCR_T *) ((( uint32_t)0x50000000) + 0x00000))->GPB_MFP |= (1UL<<15);
    ((GCR_T *) ((( uint32_t)0x50000000) + 0x00000))->ALT_MFP &= ~(1UL<<24);
    ((GCR_T *) ((( uint32_t)0x50000000) + 0x00000))->ALT_MFP |= 0x00000000UL;
...
void SYS_Init2(void){
    ...
    ((GCR_T *) ((( uint32_t)0x50000000) + 0x00000))->GPB_MFP &= ~((1UL<<9)|(1UL<<10));
    ((GCR_T *) ((( uint32_t)0x50000000) + 0x00000))->GPB_MFP |= ((1UL<<9) | (1UL<<10));
	
		((GCR_T *) ((( uint32_t)0x50000000) + 0x00000))->ALT_MFP &= ~0x00000000UL;
    ((GCR_T *) ((( uint32_t)0x50000000) + 0x00000))->ALT_MFP |= (1UL<<1);
		
		((GCR_T *) ((( uint32_t)0x50000000) + 0x00000))->ALT_MFP &= ~0x00000000UL;
    ((GCR_T *) ((( uint32_t)0x50000000) + 0x00000))->ALT_MFP |= (1UL<<0);
...
void StateMachine2(void){
    ...
    while(AskStart == 1){
		...
		TIMER_Delay(((TIMER_T *) ((( uint32_t)0x40000000) + 0x10000)), 10000);
    AskHeader = 0x07;
		DataPacketStart(AskHeader);
		while(AskStart == 1){
    ...
    BleBuffer[3] = 0x01;
		...
		while(1){
			...
			i++;
			TIMER_Delay(((TIMER_T *) ((( uint32_t)0x40000000) + 0x10000)), 500000);
		}
}
...
int32_t ReadADC(uint32_t u32Channel){
    ...
    ADC_Open(((ADC_T *) ((( uint32_t)0x40000000) + 0xE0000)), (0UL<<10), (3UL<<2), 0xF);
    ...
    ConversionData = (((u32Channel) < 8)?((((ADC_T *) ((( uint32_t)0x40000000) + 0xE0000)))->ADDR[(u32Channel)] & (0xFFFFul << 0)):((((ADC_T *) ((( uint32_t)0x40000000) + 0xE0000)))->ADDR1[(u32Channel) - 8] & (0xFFFFul << 0)));
