...
#line 13 "..\\..\\..\\..\\Library\\StdDriver\\src\\ebi.c"
...
{
    if(u32DataWidth == 8)
        ((EBI_T *) ((( uint32_t)0x50000000) + 0x10000))->EBICON &= ~(1ul << 1);
    else
        ((EBI_T *) ((( uint32_t)0x50000000) + 0x10000))->EBICON |= (1ul << 1);
    ...
    {
        case 0x0UL:
            ((EBI_T *) ((( uint32_t)0x50000000) + 0x10000))->EBICON = (((EBI_T *) ((( uint32_t)0x50000000) + 0x10000))->EBICON & ~((0x7ul << 8) | (0x7ul << 16))) |
                          (0x0UL << 8) | (1ul << 0);
            ((EBI_T *) ((( uint32_t)0x50000000) + 0x10000))->EXTIME = 0x0;
            break;
        ...
        case 0x1UL:
            ((EBI_T *) ((( uint32_t)0x50000000) + 0x10000))->EBICON = (((EBI_T *) ((( uint32_t)0x50000000) + 0x10000))->EBICON & ~((0x7ul << 8) | (0x7ul << 16))) |
                          (0x0UL << 8) | (1ul << 0)   |
                          (0x3 << 16) ;
            ((EBI_T *) ((( uint32_t)0x50000000) + 0x10000))->EXTIME = 0x03003318;
            break;
        ...
        case 0x4UL:
            ((EBI_T *) ((( uint32_t)0x50000000) + 0x10000))->EBICON = (((EBI_T *) ((( uint32_t)0x50000000) + 0x10000))->EBICON & ~((0x7ul << 8) | (0x7ul << 16))) |
                          (0x1UL << 8) | (1ul << 0)   |
                          (0x7 << 16) ;
            ((EBI_T *) ((( uint32_t)0x50000000) + 0x10000))->EXTIME = 0x07007738;
            break;
        ...
        default:
            ((EBI_T *) ((( uint32_t)0x50000000) + 0x10000))->EBICON &= ~(1ul << 0);
            break;
    }
}
...
void EBI_SetBusTiming(uint32_t u32Bank, uint32_t u32TimingConfig, uint32_t u32MclkDiv)
{
    ((EBI_T *) ((( uint32_t)0x50000000) + 0x10000))->EBICON = (((EBI_T *) ((( uint32_t)0x50000000) + 0x10000))->EBICON & ~(0x7ul << 8)) | (u32MclkDiv << 8);
    ((EBI_T *) ((( uint32_t)0x50000000) + 0x10000))->EXTIME = u32TimingConfig;
}
