...
uint8_t g_qi_tx_buffer[32];   
uint8_t g_qi_tx_size = 0;                    

static uint8_t g_qi_tx_bit_index = 0;               
static uint8_t g_qi_tx_byte_index = 0;              

static uint8_t g_qi_bit_value = 0;                  
static uint8_t g_tx_parity = 0;                     

static uint16_t g_periods=0;                          

extern uint16_t g_qi_tx_time_counter;
unsigned char fsk_delta, fsk_delta_20=2;
 
static qi_Tx_State g_qi_tx_state;					 
...
static __inline void Fsk_vStop(void)
{ 

	((EPWM_T *) ((((uint32_t)0x40000000) + (uint32_t)0x00040000) + 0x18000UL))->PERIOD[0] = ((EPWM_T *) ((((uint32_t)0x40000000) + (uint32_t)0x00040000) + 0x18000UL))->PERIOD[1] = ((EPWM_T *) ((((uint32_t)0x40000000) + (uint32_t)0x00040000) + 0x19000UL))->PERIOD[0] = ((EPWM_T *) ((((uint32_t)0x40000000) + (uint32_t)0x00040000) + 0x19000UL))->PERIOD[1] = ((EPWM_T *) ((((uint32_t)0x40000000) + (uint32_t)0x00040000) + 0x18000UL))->PERIOD[4] = ((EPWM_T *) ((((uint32_t)0x40000000) + (uint32_t)0x00040000) + 0x18000UL))->PERIOD[5] = ((EPWM_T *) ((((uint32_t)0x40000000) + (uint32_t)0x00040000) + 0x19000UL))->PERIOD[4] = ((EPWM_T *) ((((uint32_t)0x40000000) + (uint32_t)0x00040000) + 0x19000UL))->PERIOD[5] = g_periods;    
...
{ 
    ...
    g_qi_tx_bit_index = 0;
    g_qi_tx_time_counter = 512 - 1;
	g_periods = ((EPWM_T *) ((((uint32_t)0x40000000) + (uint32_t)0x00040000) + 0x18000UL))->PERIOD[4];
 ...
 void Fsk_vUpdate()
 {
		 if( ((EPWM_T *) ((((uint32_t)0x40000000) + (uint32_t)0x00040000) + 0x18000UL))->PERIOD[4] == g_periods)
		 {
				 if(qi_FSKPolarity == 1)
				 {
						 ((EPWM_T *) ((((uint32_t)0x40000000) + (uint32_t)0x00040000) + 0x18000UL))->PERIOD[0] = ((EPWM_T *) ((((uint32_t)0x40000000) + (uint32_t)0x00040000) + 0x18000UL))->PERIOD[1] = ((EPWM_T *) ((((uint32_t)0x40000000) + (uint32_t)0x00040000) + 0x19000UL))->PERIOD[0] = ((EPWM_T *) ((((uint32_t)0x40000000) + (uint32_t)0x00040000) + 0x19000UL))->PERIOD[1] = ((EPWM_T *) ((((uint32_t)0x40000000) + (uint32_t)0x00040000) + 0x18000UL))->PERIOD[4] = ((EPWM_T *) ((((uint32_t)0x40000000) + (uint32_t)0x00040000) + 0x18000UL))->PERIOD[5] = ((EPWM_T *) ((((uint32_t)0x40000000) + (uint32_t)0x00040000) + 0x19000UL))->PERIOD[4] = ((EPWM_T *) ((((uint32_t)0x40000000) + (uint32_t)0x00040000) + 0x19000UL))->PERIOD[5] = g_periods + fsk_delta;
				 }
				 else
						 ((EPWM_T *) ((((uint32_t)0x40000000) + (uint32_t)0x00040000) + 0x18000UL))->PERIOD[0] = ((EPWM_T *) ((((uint32_t)0x40000000) + (uint32_t)0x00040000) + 0x18000UL))->PERIOD[1] = ((EPWM_T *) ((((uint32_t)0x40000000) + (uint32_t)0x00040000) + 0x19000UL))->PERIOD[0] = ((EPWM_T *) ((((uint32_t)0x40000000) + (uint32_t)0x00040000) + 0x19000UL))->PERIOD[1]=((EPWM_T *) ((((uint32_t)0x40000000) + (uint32_t)0x00040000) + 0x18000UL))->PERIOD[4] = ((EPWM_T *) ((((uint32_t)0x40000000) + (uint32_t)0x00040000) + 0x18000UL))->PERIOD[5] = ((EPWM_T *) ((((uint32_t)0x40000000) + (uint32_t)0x00040000) + 0x19000UL))->PERIOD[4] = ((EPWM_T *) ((((uint32_t)0x40000000) + (uint32_t)0x00040000) + 0x19000UL))->PERIOD[5] = g_periods - fsk_delta;
		 }
...
static __inline void Fsk_dataEndCheck( void )
{
