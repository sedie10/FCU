...
#line 9 "..\\..\\Library\\StdDriver\\src\\ecap.c"
...
void ECAP_Open(ECAP_T* ecap, uint32_t u32FuncMask)
{
    ...
    ecap->CTL0 = ecap->CTL0 & ~((0x1ul << (28)));

     
    ecap->CTL0 |= (0x1ul << (29)) | (u32FuncMask);
}
...
void ECAP_EnableINT(ECAP_T* ecap, uint32_t u32Mask)
{
    ...
    if(ecap == (ECAP_T*)((ECAP_T *) ((((uint32_t)0x40000000) + (uint32_t)0x00040000) + 0x74000UL)))
    {
