...
static __inline __attribute__ ((section(".ramfunc"))) void ledCntrol(uint8_t red,uint8_t green, uint8_t blue)
{ 

	(*((volatile uint32_t *)(((((uint32_t)0x40000000) + 0x04800UL)+(0x40*(4))) + ((5)<<2)))) 	= red; 
	(*((volatile uint32_t *)(((((uint32_t)0x40000000) + 0x04800UL)+(0x40*(4))) + ((4)<<2)))) 	= green;
	(*((volatile uint32_t *)(((((uint32_t)0x40000000) + 0x04800UL)+(0x40*(4))) + ((3)<<2)))) 	= blue;
}
...
__attribute__ ((section(".ramfunc"))) void led_state_machine(void)
{
    ...
    {
        ledCntrol((led_mask & 0x01 ? 0:1),(led_mask & 0x08 ? 0:1), (led_mask & 0x40 ? 0:1));
