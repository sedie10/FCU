...
{	
	...
	((((EADC_T *) ((((uint32_t)0x40000000) + (uint32_t)0x00040000) + 0x03000UL)))->CTL |= (((0x00000001UL)) << (2)));
	
	
	((((EADC_T *) ((((uint32_t)0x40000000) + (uint32_t)0x00040000) + 0x03000UL)))->INTSRC[(0)] |= ((0x00000001UL)<<ch));
	...
	((((EADC_T *) ((((uint32_t)0x40000000) + (uint32_t)0x00040000) + 0x03000UL)))->SWTRG = ((0x00000001UL)<<ch));            
	...
	while(((((((EADC_T *) ((((uint32_t)0x40000000) + (uint32_t)0x00040000) + 0x03000UL)))->STATUS0 & (0xfffful << (0))) | (((((EADC_T *) ((((uint32_t)0x40000000) + (uint32_t)0x00040000) + 0x03000UL)))->STATUS1 & (0x7ul << (0))) << 16)) & (((0x00000001UL)<<ch))) != ((0x00000001UL)<<ch));
	...
	adc_test = ( ((EADC_T *) ((((uint32_t)0x40000000) + (uint32_t)0x00040000) + 0x03000UL))->DAT[ch] ) & ( 0x0fff );
	if(ch == 3 )
	{
		adc_test = ( ((EADC_T *) ((((uint32_t)0x40000000) + (uint32_t)0x00040000) + 0x03000UL))->DAT[3] ) & ( 0x0fff );		
		return adc_test;
	}
	else
	{
