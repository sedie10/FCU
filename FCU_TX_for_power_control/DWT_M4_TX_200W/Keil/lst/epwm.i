...
#line 11 "..\\..\\Library\\StdDriver\\src\\epwm.c"
...
uint32_t EPWM_ConfigCaptureChannel(EPWM_T *epwm, uint32_t u32ChannelNum, uint32_t u32UnitTimeNsec, uint32_t u32CaptureEdge)
{
    ...
    if(epwm == ((EPWM_T *) ((((uint32_t)0x40000000) + (uint32_t)0x00040000) + 0x18000UL)))
    {
        u32Src = ((CLK_T *) (((uint32_t)0x40000000) + 0x00200UL))->CLKSEL2 & (0x1ul << (0));
    }
    else      
    {
        u32Src = ((CLK_T *) (((uint32_t)0x40000000) + 0x00200UL))->CLKSEL2 & (0x1ul << (1));
    }
    ...
    u16Prescale -= 1U;
    ((epwm)->CLKPSC[(u32ChannelNum) >> 1] = (u16Prescale));

     
    (epwm)->CTL1 = ((epwm)->CTL1 & ~((1UL << (0)) << (u32ChannelNum << 1U))) | (1UL << (u32ChannelNum << 1U));
     
    (epwm)->CTL1 &= ~((1UL << (16)) << u32ChannelNum);
    ((epwm)->PERIOD[(u32ChannelNum)] = (u16CNR));
...
uint32_t EPWM_ConfigOutputChannel(EPWM_T *epwm, uint32_t u32ChannelNum, uint32_t u32Frequency, uint32_t u32DutyCycle)
{
    ...
    u32Prescale -= 1U;
    ((epwm)->CLKPSC[(u32ChannelNum) >> 1] = (u32Prescale));
     
    (epwm)->CTL1 = ((epwm)->CTL1 & ~(((1UL << (0)) << (u32ChannelNum << 1U))|((1UL << (16)) << u32ChannelNum)));

    u32CNR -= 1U;
    ((epwm)->PERIOD[(u32ChannelNum)] = (u32CNR));
    ((epwm)->CMPDAT[(u32ChannelNum)]= (u32DutyCycle * (u32CNR + 1U) / 100U));

    (epwm)->WGCTL0 = ((epwm)->WGCTL0 & ~(((1UL << (16)) | (1UL << (0))) << (u32ChannelNum << 1U))) |                      ((uint32_t)(2U) << ((u32ChannelNum << 1U) + (uint32_t)(0)));

    (epwm)->WGCTL1 = ((epwm)->WGCTL1 & ~(((1UL << (16)) | (1UL << (0))) << (u32ChannelNum << 1U))) |                      ((uint32_t)(1U) << ((u32ChannelNum << 1U) + (uint32_t)(0)));
...
void EPWM_EnableADCTrigger(EPWM_T *epwm, uint32_t u32ChannelNum, uint32_t u32Condition)
{
    if(u32ChannelNum < 4U)
    {
        (epwm)->EADCTS0 &= ~(((0xful << (0))) << (u32ChannelNum << 3U));
        (epwm)->EADCTS0 |= (((0x1ul << (7)) | u32Condition) << (u32ChannelNum << 3));
    }
    else
    {
        (epwm)->EADCTS1 &= ~(((0xful << (0))) << ((u32ChannelNum - 4U) << 3U));
        (epwm)->EADCTS1 |= (((0x1ul << (7)) | u32Condition) << ((u32ChannelNum - 4U) << 3U));
    }
}
...
void EPWM_DisableADCTrigger(EPWM_T *epwm, uint32_t u32ChannelNum)
{
    if(u32ChannelNum < 4U)
    {
        (epwm)->EADCTS0 &= ~((0x1ul << (7)) << (u32ChannelNum << 3U));
    }
    else
    {
        (epwm)->EADCTS1 &= ~((0x1ul << (7)) << ((u32ChannelNum - 4U) << 3U));
    }
}
...
void EPWM_ClearADCTriggerFlag(EPWM_T *epwm, uint32_t u32ChannelNum, uint32_t u32Condition)
{
    (epwm)->STATUS = ((0x1ul << (16)) << u32ChannelNum);
}
...
uint32_t EPWM_GetADCTriggerFlag(EPWM_T *epwm, uint32_t u32ChannelNum)
{
    return (((epwm)->STATUS & ((0x1ul << (16)) << u32ChannelNum))?1UL:0UL);
}
...
void EPWM_DisableDACTrigger(EPWM_T *epwm, uint32_t u32ChannelNum)
{
    (epwm)->DACTRGEN &= ~(((0x1U) | (0x100U) | (0x10000U) |                            (0x1000000U)) << u32ChannelNum);
...
uint32_t EPWM_GetDACTriggerFlag(EPWM_T *epwm, uint32_t u32ChannelNum)
{
    return (((epwm)->STATUS & (0x1ul << (24)))?1UL:0UL);
}
...
void EPWM_EnableFaultBrake(EPWM_T *epwm, uint32_t u32ChannelMask, uint32_t u32LevelMask, uint32_t u32BrakeSource)
{
    ...
    for(i = 0U; i < (6U); i ++)
    {
        if(u32ChannelMask & (1UL << i))
        {
            if((u32BrakeSource == ((0x1ul << (7)) | (0x1ul << (0)))) || (u32BrakeSource == ((0x1ul << (7)) | (0x1ul << (1)))) ||                     (u32BrakeSource == ((0x1ul << (7)) | (0x1ul << (2)))) || (u32BrakeSource == ((0x1ul << (7)) | (0x1ul << (3)))) ||                     (u32BrakeSource == ((0x1ul << (15)) | (0x1ul << (0)))) || (u32BrakeSource == ((0x1ul << (15)) | (0x1ul << (1)))) ||                     (u32BrakeSource == ((0x1ul << (15)) | (0x1ul << (2)))) || (u32BrakeSource == ((0x1ul << (15)) | (0x1ul << (3)))))



            {
                (epwm)->BRKCTL[i >> 1U] |= (u32BrakeSource & ((0x1ul << (7)) | (0x1ul << (15))));
        ...
        if(u32LevelMask & (1UL << i))
        {
            if((i & 0x1U) == 0U)
            {
                ...
                (epwm)->BRKCTL[i >> 1] &= ~(0x3ul << (16));
                (epwm)->BRKCTL[i >> 1] |= ((3U) << (16));
            }
            else
            {
                 
                (epwm)->BRKCTL[i >> 1] &= ~(0x3ul << (18));
                (epwm)->BRKCTL[i >> 1] |= ((3U) << (18));
            }
        }
        else
        {
            if((i & 0x1U) == 0U)
            {
                ...
                (epwm)->BRKCTL[i >> 1U] &= ~(0x3ul << (16));
                (epwm)->BRKCTL[i >> 1U] |= ((2U) << (16));
            }
            else
            {
                 
                (epwm)->BRKCTL[i >> 1U] &= ~(0x3ul << (18));
                (epwm)->BRKCTL[i >> 1U] |= ((2U) << (18));
            }
        }
    }
}
...
void EPWM_EnablePDMA(EPWM_T *epwm, uint32_t u32ChannelNum, uint32_t u32RisingFirst, uint32_t u32Mode)
{
    ...
    (epwm)->PDMACTL = ((epwm)->PDMACTL & ~(((0x1ul << (4)) | (0x1ul << (3)) | (0x3ul << (1))) << ((u32ChannelNum >> 1U) << 3U))) |                       (((u32IsOddCh << (4)) | (u32RisingFirst << (3)) |                         u32Mode | (0x1ul << (0))) << ((u32ChannelNum >> 1U) << 3U));
...
void EPWM_DisablePDMA(EPWM_T *epwm, uint32_t u32ChannelNum)
{
    (epwm)->PDMACTL &= ~((0x1ul << (0)) << ((u32ChannelNum >> 1U) << 3U));
}
...
void EPWM_EnableDeadZone(EPWM_T *epwm, uint32_t u32ChannelNum, uint32_t u32Duration)
{
    ...
    (epwm)->DTCTL[(u32ChannelNum) >> 1U] &= ~(0xffful << (0));
    (epwm)->DTCTL[(u32ChannelNum) >> 1U] |= (0x1ul << (16)) | u32Duration;
}
...
void EPWM_DisableDeadZone(EPWM_T *epwm, uint32_t u32ChannelNum)
{
    ...
    (epwm)->DTCTL[(u32ChannelNum) >> 1U] &= ~(0x1ul << (16));
}
...
uint32_t EPWM_GetCaptureIntFlag(EPWM_T *epwm, uint32_t u32ChannelNum)
{
    return (((((epwm)->CAPIF & ((0x1ul << (8)) << u32ChannelNum)) ? 1UL : 0UL) << 1) |             (((epwm)->CAPIF & ((0x1ul << (0)) << u32ChannelNum)) ? 1UL : 0UL));
...
void EPWM_DisableDutyInt(EPWM_T *epwm, uint32_t u32ChannelNum)
{
    (epwm)->INTEN0 &= ~((uint32_t)((1U << (24)) | (1U << (16))) << u32ChannelNum);
}
...
void EPWM_ClearDutyIntFlag(EPWM_T *epwm, uint32_t u32ChannelNum)
{
    (epwm)->INTSTS0 = ((0x1ul << (16)) | (0x1ul << (24))) << u32ChannelNum;
}
...
uint32_t EPWM_GetDutyIntFlag(EPWM_T *epwm, uint32_t u32ChannelNum)
{
    return ((((epwm)->INTSTS0 & (((0x1ul << (24)) | (0x1ul << (16))) << u32ChannelNum))) ? 1UL : 0UL);
}
...
void EPWM_EnablePeriodInt(EPWM_T *epwm, uint32_t u32ChannelNum,  uint32_t u32IntPeriodType)
{
    (epwm)->INTEN0 |= ((1UL << (8)) << u32ChannelNum);
}
...
void EPWM_ClearPeriodIntFlag(EPWM_T *epwm, uint32_t u32ChannelNum)
{
    (epwm)->INTSTS0 = ((1UL << (8)) << u32ChannelNum);
}
...
uint32_t EPWM_GetPeriodIntFlag(EPWM_T *epwm, uint32_t u32ChannelNum)
{
    return ((((epwm)->INTSTS0 & ((1UL << (8)) << u32ChannelNum))) ? 1UL : 0UL);
}
...
void EPWM_EnableZeroInt(EPWM_T *epwm, uint32_t u32ChannelNum)
{
    (epwm)->INTEN0 |= ((1UL << (0)) << u32ChannelNum);
}
...
void EPWM_ClearZeroIntFlag(EPWM_T *epwm, uint32_t u32ChannelNum)
{
    (epwm)->INTSTS0 = ((1UL << (0)) << u32ChannelNum);
}
...
uint32_t EPWM_GetZeroIntFlag(EPWM_T *epwm, uint32_t u32ChannelNum)
{
    return ((((epwm)->INTSTS0 & ((1UL << (0)) << u32ChannelNum))) ? 1UL : 0UL);
}
...
void EPWM_EnableAcc(EPWM_T *epwm, uint32_t u32ChannelNum, uint32_t u32IntFlagCnt, uint32_t u32IntAccSrc)
{
    (epwm)->IFA[u32ChannelNum] = (((epwm)->IFA[u32ChannelNum] & ~(((0xfffful << (0)) | (0x3ul << (28))))) |                                   ((0x1ul << (31)) | (u32IntAccSrc << (28)) | u32IntFlagCnt) );
...
void EPWM_DisableAcc(EPWM_T *epwm, uint32_t u32ChannelNum)
{
    (epwm)->IFA[u32ChannelNum] = ((epwm)->IFA[u32ChannelNum] & ~((0x1ul << (31))));
}
...
void EPWM_EnableAccStopMode(EPWM_T *epwm, uint32_t u32ChannelNum)
{
    (epwm)->IFA[u32ChannelNum] |= (0x1ul << (24));
}
...
void EPWM_ClearFTDutyIntFlag(EPWM_T *epwm, uint32_t u32ChannelNum)
{
    (epwm)->FTCI = (((0x1ul << (0)) | (0x1ul << (8))) << (u32ChannelNum >> 1U));
}
...
uint32_t EPWM_GetFTDutyIntFlag(EPWM_T *epwm, uint32_t u32ChannelNum)
{
    return (((epwm)->FTCI & (((0x1ul << (0)) | (0x1ul << (8))) << (u32ChannelNum >> 1U))) ? 1UL : 0UL);
}
...
void EPWM_ConfigSyncPhase(EPWM_T *epwm, uint32_t u32ChannelNum, uint32_t u32SyncSrc, uint32_t u32Direction, uint32_t u32StartPhase)
{
    ...
    u32ChannelNum >>= 1U;
    (epwm)->SYNC = (((epwm)->SYNC & ~(((3UL << (8)) << (u32ChannelNum << 1U)) | ((1UL << (24)) << u32ChannelNum))) |                     (u32Direction << (24) << u32ChannelNum) | ((u32SyncSrc << (8)) << (u32ChannelNum << 1U)));
...
void EPWM_EnableSyncNoiseFilter(EPWM_T *epwm, uint32_t u32ClkCnt, uint32_t u32ClkDivSel)
{
    (epwm)->SYNC = ((epwm)->SYNC & ~((0x7ul << (20)) | (0x7ul << (17)))) |                    ((u32ClkCnt << (20)) | (u32ClkDivSel << (17)) | (0x1ul << (16)));
...
void EPWM_SetClockSource(EPWM_T *epwm, uint32_t u32ChannelNum, uint32_t u32ClkSrcSel)
{
    (epwm)->CLKSRC = ((epwm)->CLKSRC & ~((0x7ul << (0)) << ((u32ChannelNum >> 1U) << 3U))) |                      (u32ClkSrcSel << ((u32ChannelNum >> 1U) << 3U));
...
void EPWM_EnableBrakeNoiseFilter(EPWM_T *epwm, uint32_t u32BrakePinNum, uint32_t u32ClkCnt, uint32_t u32ClkDivSel)
{
    (epwm)->BNF = ((epwm)->BNF & ~(((0x7ul << (4)) | (0x7ul << (1))) << (u32BrakePinNum << 3U))) |                   (((u32ClkCnt << (4)) | (u32ClkDivSel << (1)) | (0x1ul << (0))) << (u32BrakePinNum << 3U));
...
void EPWM_DisableBrakeNoiseFilter(EPWM_T *epwm, uint32_t u32BrakePinNum)
{
    (epwm)->BNF &= ~((0x1ul << (0)) << (u32BrakePinNum << 3U));
}
...
void EPWM_EnableBrakePinInverse(EPWM_T *epwm, uint32_t u32BrakePinNum)
{
    (epwm)->BNF |= ((0x1ul << (7)) << (u32BrakePinNum << 3U));
}
...
void EPWM_DisableBrakePinInverse(EPWM_T *epwm, uint32_t u32BrakePinNum)
{
    (epwm)->BNF &= ~((0x1ul << (7)) << (u32BrakePinNum * (uint32_t)(8)));
}
...
void EPWM_SetBrakePinSource(EPWM_T *epwm, uint32_t u32BrakePinNum, uint32_t u32SelAnotherModule)
{
    (epwm)->BNF = ((epwm)->BNF & ~((0x1ul << (16)) << (u32BrakePinNum << 3U))) | (u32SelAnotherModule << ((uint32_t)(16) + (u32BrakePinNum << 3U)));
}
...
uint32_t EPWM_GetWrapAroundFlag(EPWM_T *epwm, uint32_t u32ChannelNum)
{
    return (((epwm)->STATUS & ((0x1ul << (0)) << u32ChannelNum)) ? 1UL : 0UL);
}
...
void EPWM_ClearWrapAroundFlag(EPWM_T *epwm, uint32_t u32ChannelNum)
{
    (epwm)->STATUS = ((0x1ul << (0)) << u32ChannelNum);
}
