...
uint16_t g_qi_tx_time_counter = 0;    
...
{    
	...
	u32Status = ((((ECAP_T *) ((((uint32_t)0x40000000) + (uint32_t)0x00040000) + 0x74000UL)))->STATUS);   
	
	     
	if((u32Status & (0x1ul << (0))) == (0x1ul << (0)))    
	{        
		         

		((((ECAP_T *) ((((uint32_t)0x40000000) + (uint32_t)0x00040000) + 0x74000UL)))->STATUS = ((0x1ul << (0)) | (0x1ul << (4)) | (0x1ul << (5))));    
		         
		ASK_vDecode((uint32_t)(((ECAP_T *) ((((uint32_t)0x40000000) + (uint32_t)0x00040000) + 0x74000UL))->HLD0 & 0x00FFFFFF));
	}    
	
	     
	else if((u32Status & (0x1ul << (4))) == (0x1ul << (4)))    
	{        
		         
		((((ECAP_T *) ((((uint32_t)0x40000000) + (uint32_t)0x00040000) + 0x74000UL)))->STATUS = ((0x1ul << (4))));    

		ASK_vDecode((uint32_t)( 34000 & 0x00FFFFFF));
	}   
	 
	if((u32Status & (0x1ul << (5))) == (0x1ul << (5)))
	{
			 
			((((ECAP_T *) ((((uint32_t)0x40000000) + (uint32_t)0x00040000) + 0x74000UL)))->STATUS = ((0x1ul << (5))));
	}	
}
...
#line 135 "..\\Isr.c"
	...
	TIMER_ClearCaptureIntFlag(((TIMER_T *) ((((uint32_t)0x40000000) + (uint32_t)0x00040000) + 0x10000UL)));		
...
void EPWM0P2_IRQHandler(void)
{
	...
	EPWM_ClearPeriodIntFlag(((EPWM_T *) ((((uint32_t)0x40000000) + (uint32_t)0x00040000) + 0x18000UL)), 4);
	g_qi_tx_time_counter++; 
	if(g_qi_tx_time_counter == 256) 
	{    
		Fsk_vStart(256);
	} 
	else if(g_qi_tx_time_counter == 512) 
	{ 
...
__attribute__ ((section(".ramfunc"))) void TMR1_IRQHandler(void) 
{
...
#line 275 "..\\Isr.c"
		...
		if ((vbus_value > 4096) && (dcdc_enable == 1))
		{
		    if( ++qitx_OvCount > 10 )
		    {
