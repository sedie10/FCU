...
#line 9 "..\\..\\Library\\StdDriver\\src\\eadc.c"
...
{
    eadc->SCTL[u32ModuleNum] &= ~((0x1ul << (5)) | (0x1ul << (4)) | (0x1ful << (16)) | (0xful << (0)));
...
{
    eadc->SCTL[u32ModuleNum] &= ~((0x3ul << (6)) | (0xfful << (8)));
    eadc->SCTL[u32ModuleNum] |= ((u32TriggerDelayTime << (8)) | u32DelayClockDivider);
}
...
void EADC_SetExtendSampleTime(EADC_T *eadc, uint32_t u32ModuleNum, uint32_t u32ExtendSampleTime)
{
    eadc->SCTL[u32ModuleNum] &= ~(0xfful << (24));

    eadc->SCTL[u32ModuleNum] |= (u32ExtendSampleTime << (24));
