...
#line 10 "..\\..\\Library\\StdDriver\\src\\uart.c"
...
#line 11 "..\\..\\Library\\StdDriver\\src\\uart.c"
...
void UART_Open(UART_T* uart, uint32_t u32baudrate)
{
    ...
    uint32_t u32ClkTbl[4] = {(12000000UL), 0ul, (32768UL), (12000000UL)};
    uint32_t u32Baud_Div = 0ul;


    if(uart==(UART_T*)((UART_T *) ((((uint32_t)0x40000000) + (uint32_t)0x00040000) + 0x30000UL)))
    {
         
        u32UartClkSrcSel = ((uint32_t)(((CLK_T *) (((uint32_t)0x40000000) + 0x00200UL))->CLKSEL1 & (0x3ul << (24)))) >> (24);
         
        u32UartClkDivNum = (((CLK_T *) (((uint32_t)0x40000000) + 0x00200UL))->CLKDIV0 & (0xful << (8))) >> (8);
    }
    else if(uart==(UART_T*)((UART_T *) ((((uint32_t)0x40000000) + (uint32_t)0x00040000) + 0x31000UL)))
    {
         
        u32UartClkSrcSel = (((CLK_T *) (((uint32_t)0x40000000) + 0x00200UL))->CLKSEL1 & (0x3ul << (26))) >> (26);
         
        u32UartClkDivNum = (((CLK_T *) (((uint32_t)0x40000000) + 0x00200UL))->CLKDIV0 & (0xful << (12))) >> (12);
    }
    else if(uart==(UART_T*)((UART_T *) ((((uint32_t)0x40000000) + (uint32_t)0x00040000) + 0x32000UL)))
    {
         
        u32UartClkSrcSel = (((CLK_T *) (((uint32_t)0x40000000) + 0x00200UL))->CLKSEL3 & (0x3ul << (24))) >> (24);
         
        u32UartClkDivNum = (((CLK_T *) (((uint32_t)0x40000000) + 0x00200UL))->CLKDIV4 & (0xful << (0))) >> (0);
    }
    else if(uart==(UART_T*)((UART_T *) ((((uint32_t)0x40000000) + (uint32_t)0x00040000) + 0x33000UL)))
    {
         
        u32UartClkSrcSel = (((CLK_T *) (((uint32_t)0x40000000) + 0x00200UL))->CLKSEL3 & (0x3ul << (26))) >> (26);
         
        u32UartClkDivNum = (((CLK_T *) (((uint32_t)0x40000000) + 0x00200UL))->CLKDIV4 & (0xful << (4))) >> (4);
    }
    else if(uart==(UART_T*)((UART_T *) ((((uint32_t)0x40000000) + (uint32_t)0x00040000) + 0x34000UL)))
    {
         
        u32UartClkSrcSel = (((CLK_T *) (((uint32_t)0x40000000) + 0x00200UL))->CLKSEL3 & (0x3ul << (28))) >> (28);
         
        u32UartClkDivNum = (((CLK_T *) (((uint32_t)0x40000000) + 0x00200UL))->CLKDIV4 & (0xful << (8))) >> (8);
    }
    else if(uart==(UART_T*)((UART_T *) ((((uint32_t)0x40000000) + (uint32_t)0x00040000) + 0x35000UL)))
    {
         
        u32UartClkSrcSel = (((CLK_T *) (((uint32_t)0x40000000) + 0x00200UL))->CLKSEL3 & (0x3ul << (30))) >> (30);
         
        u32UartClkDivNum = (((CLK_T *) (((uint32_t)0x40000000) + 0x00200UL))->CLKDIV4 & (0xful << (12))) >> (12);
    }
    ...
    if(u32baudrate != 0ul)
    {
        u32Baud_Div = (((((u32ClkTbl[u32UartClkSrcSel]) / (u32UartClkDivNum + 1ul)) + ((u32baudrate)/2ul)) / (u32baudrate))-2ul);

        if(u32Baud_Div > 0xFFFFul)
        {
            uart->BAUD = ((0ul) | (((((u32ClkTbl[u32UartClkSrcSel]) / (u32UartClkDivNum + 1ul)) + ((u32baudrate)*8ul)) / (u32baudrate) >> 4ul)-2ul));
        }
        else
        {
            uart->BAUD = (((0x1ul << (29)) | (0x1ul << (28))) | u32Baud_Div);
        }
    }
}
...
{
    uint32_t u32UartClkSrcSel=0ul, u32UartClkDivNum=0ul;
    uint32_t u32ClkTbl[4ul] = {(12000000UL), 0ul, (32768UL), (12000000UL)};
    uint32_t u32Baud_Div = 0ul;
    ...
    if(uart==(UART_T*)((UART_T *) ((((uint32_t)0x40000000) + (uint32_t)0x00040000) + 0x30000UL)))
    {
        ...
        u32UartClkSrcSel = (((CLK_T *) (((uint32_t)0x40000000) + 0x00200UL))->CLKSEL1 & (0x3ul << (24))) >> (24);
...
void UART_SelectIrDAMode(UART_T* uart, uint32_t u32Buadrate, uint32_t u32Direction)
{
    ...
    if(uart==((UART_T *) ((((uint32_t)0x40000000) + (uint32_t)0x00040000) + 0x30000UL)))
    {
    ...
    else if(uart==((UART_T *) ((((uint32_t)0x40000000) + (uint32_t)0x00040000) + 0x31000UL)))
    {
    ...
    else if(uart==((UART_T *) ((((uint32_t)0x40000000) + (uint32_t)0x00040000) + 0x32000UL)))
    {
    ...
    else if(uart==((UART_T *) ((((uint32_t)0x40000000) + (uint32_t)0x00040000) + 0x33000UL)))
    {
    ...
    else if(uart==((UART_T *) ((((uint32_t)0x40000000) + (uint32_t)0x00040000) + 0x34000UL)))
    {
    ...
    else if(uart==((UART_T *) ((((uint32_t)0x40000000) + (uint32_t)0x00040000) + 0x35000UL)))
    {
    ...
    if(u32Buadrate != 0ul)
    {
        u32Baud_Div = (((((u32ClkTbl[u32UartClkSrcSel]) / (u32UartClkDivNum + 1ul)) + ((u32Buadrate)*8ul)) / (u32Buadrate) >> 4ul)-2ul);

        if(u32Baud_Div < 0xFFFFul)
        {
            uart->BAUD = ((0ul) | u32Baud_Div);
        }
        else
        {
        }
