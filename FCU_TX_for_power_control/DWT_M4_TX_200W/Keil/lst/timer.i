...
#line 8 "..\\..\\Library\\StdDriver\\src\\timer.c"
...
void TIMER_EnableCapture(TIMER_T *timer, uint32_t u32CapMode, uint32_t u32Edge)
{
    timer->EXTCTL = (timer->EXTCTL & ~((0x1ul << (4)) | (0x7ul << (12)))) |
...
uint32_t TIMER_GetModuleClock(TIMER_T *timer)
{
    ...
    const uint32_t au32Clk[] = {(12000000UL), (32768UL), 0UL, 0UL, 0UL, (10000UL), 0UL, (12000000UL)};

    if(timer == ((TIMER_T *) ((((uint32_t)0x40000000) + (uint32_t)0x00040000) + 0x10000UL)))
    {
        u32Src = (((CLK_T *) (((uint32_t)0x40000000) + 0x00200UL))->CLKSEL1 & (0x7ul << (8))) >> (8);
    }
    else if(timer == ((TIMER_T *) ((((uint32_t)0x40000000) + (uint32_t)0x00040000) + 0x10100UL)))
    {
        u32Src = (((CLK_T *) (((uint32_t)0x40000000) + 0x00200UL))->CLKSEL1 & (0x7ul << (12))) >> (12);
    }
    else if(timer == ((TIMER_T *) ((((uint32_t)0x40000000) + (uint32_t)0x00040000) + 0x11000UL)))
    {
        u32Src = (((CLK_T *) (((uint32_t)0x40000000) + 0x00200UL))->CLKSEL1 & (0x7ul << (16))) >> (16);
    }
    else       
    {
        u32Src = (((CLK_T *) (((uint32_t)0x40000000) + 0x00200UL))->CLKSEL1 & (0x7ul << (20))) >> (20);
    }

    if(u32Src == 2UL)
    {
        if((timer == ((TIMER_T *) ((((uint32_t)0x40000000) + (uint32_t)0x00040000) + 0x10000UL))) || (timer == ((TIMER_T *) ((((uint32_t)0x40000000) + (uint32_t)0x00040000) + 0x10100UL))))
        {
                             ...
                             uint32_t u32EnableInt)
{
    ...
    t = (timer == ((TIMER_T *) ((((uint32_t)0x40000000) + (uint32_t)0x00040000) + 0x10000UL))) ? ((TIMER_T *) ((((uint32_t)0x40000000) + (uint32_t)0x00040000) + 0x10100UL)) : ((TIMER_T *) ((((uint32_t)0x40000000) + (uint32_t)0x00040000) + 0x11100UL));

    t->CMP = 0xFFFFFFUL;
    t->EXTCTL = u32EnableInt ? (0x1ul << (5)) : 0UL;
    timer->CTL = (0x1ul << (19)) | (0x1ul << (30));
...
void TIMER_SetTriggerSource(TIMER_T *timer, uint32_t u32Src)
{
    timer->TRGCTL = (timer->TRGCTL & ~(0x1ul << (0))) | u32Src;
}
...
void TIMER_SetTriggerTarget(TIMER_T *timer, uint32_t u32Mask)
{
    timer->TRGCTL = (timer->TRGCTL & ~((0x1ul << (1)) | (0x1ul << (3)) | (0x1ul << (2)) | (0x1ul << (4)))) | u32Mask;
}
