...
#line 10 "..\\..\\Library\\StdDriver\\src\\sys.c"
...
void SYS_EnableBOD(int32_t i32Mode, uint32_t u32BODLevel)
{
    ...
    ((SYS_T *) (((uint32_t)0x40000000) + 0x00000UL))->BODCTL = (((SYS_T *) (((uint32_t)0x40000000) + 0x00000UL))->BODCTL & ~(0x1ul << (3))) | (uint32_t)i32Mode;

     
    ((SYS_T *) (((uint32_t)0x40000000) + 0x00000UL))->BODCTL = (((SYS_T *) (((uint32_t)0x40000000) + 0x00000UL))->BODCTL & ~(0x7ul << (16))) | u32BODLevel;
}
