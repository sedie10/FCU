...
{ 
   ...
   aping_thresh_last = threshold - ((1648 - vbus_counts())>>1); 
   ...
   PWM_vUpdateBuckbooster( 960, 960*192/200);



    (*((volatile uint32_t *)(((((uint32_t)0x40000000) + 0x04800UL)+(0x40*(0))) + ((12)<<2)))) = 1;
	for (i = 0;i < 200;i++)
	{
			__nop();
	}
    ...
    (*((volatile uint32_t *)(((((uint32_t)0x40000000) + 0x04800UL)+(0x40*(0))) + ((12)<<2)))) = 0;
