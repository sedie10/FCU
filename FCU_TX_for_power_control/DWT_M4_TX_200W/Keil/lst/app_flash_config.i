...
#line 2 "..\\app_flash_config.c"
#line 3 "..\\app_flash_config.c"
...
void app_flash_config_set_defaults( void )
{
	...
	flash_config_ram.analog_ping_threshold = 345;

	flash_config_ram.vbus_ov_threshold = 4096;

	flash_config_ram.rth_ot_threshold = 71;
	flash_config_ram.rth_ot_hysteresis_threshood = 71;

	flash_config_ram.vdroop_ref = (1304 << 16);
	flash_config_ram.vdroop_Kp = 0x000a0000;
	flash_config_ram.vdroop_max = (275 << 16);

	flash_config_ram.efficiency_threshold = 65;;
	flash_config_ram.flash_valid_key = 0xBEEFDEAD;
