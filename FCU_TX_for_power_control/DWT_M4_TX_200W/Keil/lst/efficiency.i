...
__attribute__ ((section(".ramfunc"))) void efficiency_reset(void)
{
...
__attribute__ ((section(".ramfunc"))) int efficiency_low(int i_sense_counts, int vbus_counts)
{
  ...
  if (qi_received_power < 1280) 
    qi_received_power = 1280;   
  
  
  
#line 72 "..\\efficiency.c"
  ...
  temp_int = temp_int * (i_sense_counts - adc_offset_isense - 05);
...
__attribute__ ((section(".ramfunc"))) int power_calibration_phase(int i_sense_counts, int vbus_counts, int mode)
{
