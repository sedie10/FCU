...
PingPongEntry selected_mod_state[4];

const ModulationEntry mod_states[1] = 
  { PingPong2, { { VoltagePeak, 5, 0.43989563, 8, PingPong2 }, { VoltagePeak, 5, 0.32029724, 12, PingPong4 }, { IsensePhase, 5, 0.23904419, 4, PingPong4 }, { IsensePhase, 3, 0.23904419, 10, PingPong2 } } };



ModulationState modulation_state;                                
ModulationType modulation_type;                                  
int hysteresis_scale_factor;                                     



static void changeModes(ModulationState new_state);

void initModulation(void) 
{
...
__attribute__ ((section(".ramfunc"))) int resetHysteresis(void)
{
	return selected_mod_state[modulation_state].default_hys;
}

__attribute__ ((section(".ramfunc"))) void resetDynamicHysteresis(void)
{
	dynamic_hysteresis = 0;
}
    
__attribute__ ((section(".ramfunc"))) void resetModulation(void)
{
	changeModes(starting_mod_state);
}

__attribute__ ((section(".ramfunc"))) int limitLpFilterHys(int raw_hys)
{
...
__attribute__ ((section(".ramfunc"))) void changeModes(ModulationState new_state)
{
...
#line 128 "..\\modulation.c"
  
}
    
__attribute__ ((section(".ramfunc"))) void advanceModulation(void)
{
