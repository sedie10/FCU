...
#line 199 "..\\..\\Library\\Device\\Nuvoton\\M480\\Include\\M480.h"
...
#line 206 "..\\..\\Library\\Device\\Nuvoton\\M480\\Include\\M480.h"
...
#line 258 "..\\..\\Library\\Device\\Nuvoton\\M480\\Include\\M480.h"
...
#line 298 "..\\..\\Library\\Device\\Nuvoton\\M480\\Include\\M480.h"

 
#line 323 "..\\..\\Library\\Device\\Nuvoton\\M480\\Include\\M480.h"


 
#line 351 "..\\..\\Library\\Device\\Nuvoton\\M480\\Include\\M480.h"

#line 359 "..\\..\\Library\\Device\\Nuvoton\\M480\\Include\\M480.h"
...
#line 398 "..\\..\\Library\\Device\\Nuvoton\\M480\\Include\\M480.h"

#line 406 "..\\..\\Library\\Device\\Nuvoton\\M480\\Include\\M480.h"

#line 460 "..\\..\\Library\\Device\\Nuvoton\\M480\\Include\\M480.h"
...
#line 485 "..\\..\\Library\\StdDriver\\inc\\sys.h"
 
#line 607 "..\\..\\Library\\StdDriver\\inc\\sys.h"
 
#line 715 "..\\..\\Library\\StdDriver\\inc\\sys.h"
 
#line 782 "..\\..\\Library\\StdDriver\\inc\\sys.h"
 
#line 838 "..\\..\\Library\\StdDriver\\inc\\sys.h"
 
#line 890 "..\\..\\Library\\StdDriver\\inc\\sys.h"
 
#line 976 "..\\..\\Library\\StdDriver\\inc\\sys.h"
 
#line 1053 "..\\..\\Library\\StdDriver\\inc\\sys.h"
 
#line 1112 "..\\..\\Library\\StdDriver\\inc\\sys.h"
 
#line 1146 "..\\..\\Library\\StdDriver\\inc\\sys.h"
 
#line 1196 "..\\..\\Library\\StdDriver\\inc\\sys.h"
 
#line 1251 "..\\..\\Library\\StdDriver\\inc\\sys.h"
 
#line 1291 "..\\..\\Library\\StdDriver\\inc\\sys.h"
 
#line 1326 "..\\..\\Library\\StdDriver\\inc\\sys.h"
...
#line 69 "..\\..\\Library\\StdDriver\\inc\\eadc.h"
...
#line 440 "..\\..\\Library\\StdDriver\\inc\\eadc.h"
...
#line 465 "..\\..\\Library\\StdDriver\\inc\\eadc.h"
...
#line 490 "..\\..\\Library\\StdDriver\\inc\\eadc.h"
...
#line 515 "..\\..\\Library\\StdDriver\\inc\\eadc.h"
...
#line 158 "..\\..\\Library\\StdDriver\\inc\\hsusbd.h"
...
#line 6 "..\\application.h"
#line 1 "..\\WPCQiTx.h"
#line 388 "..\\WPCQiTx.h"
 
 
#line 7 "..\\application.h"
#line 1 "..\\app_flash_config.h"



#line 1 "..\\application.h"

#line 132 "..\\application.h"

#line 5 "..\\app_flash_config.h"
...
typedef struct 
{
  uint16_t analog_ping_threshold;        
  fix16_t vdroop_ref;                    
  fix16_t vdroop_Kp;                     
  fix16_t vdroop_max;                    
  uint16_t vbus_ov_threshold;            
  uint16_t rth_ot_threshold;             
  uint16_t rth_ot_hysteresis_threshood;  
  int32_t efficiency_threshold;          
  uint32_t flash_valid_key;              
...
extern __attribute__ ((section(".ramfunc"))) void WPCQi_HandleControlErrorPacket(int update_cep);          
...
#line 9 "..\\application.h"
#line 10 "..\\application.h"
#line 11 "..\\application.h"
#line 1 "..\\Adc.h"
...
static __inline __attribute__ ((section(".ramfunc"))) uint16_t vsense_analog_counts(void)   { return ADC_Convert(3);}
static __inline __attribute__ ((section(".ramfunc"))) uint16_t vsense_digital_counts(void)    { return ADC_Convert(3);}
static __inline __attribute__ ((section(".ramfunc"))) uint16_t isense_counts(void)             { return ADC_Convert(1);}
static __inline __attribute__ ((section(".ramfunc"))) uint16_t vbus_counts(void)               { return ADC_Convert(0);}
static __inline __attribute__ ((section(".ramfunc"))) uint16_t rth_counts(void)                 { return ADC_Convert(2);}
static __inline __attribute__ ((section(".ramfunc"))) uint16_t overvolt_counts(void)      			{ return ADC_Convert(4);}
static __inline __attribute__ ((section(".ramfunc"))) uint16_t q_peak_hold_counts(void)  		{ return ADC_Convert(5);}
static __inline __attribute__ ((section(".ramfunc"))) uint16_t fo_balanced_counts(void)   { return ADC_Convert(6);}
...
extern __attribute__ ((section(".ramfunc"))) void efficiency_reset(void);                               
extern __attribute__ ((section(".ramfunc"))) int efficiency_low(int i_sense_counts, int v_sense_counts);    

extern __attribute__ ((section(".ramfunc"))) int power_calibration_phase(int i_sense_counts, int vbus_counts, int mode);


extern void vdroop_control(int vin_counts);                               
...
extern int uart_comm_deep_sleep_emulate;                 

extern int efficiency;                               

extern uint8_t qi_end_transfer_code;                     
extern uint8_t qi_signal_strength;                       
extern signed char qi_control_error_value;               
extern fix16_t qi_control_error_value_f16;           
extern uint32_t qi_received_power;                        
...
extern uint8_t qi_FSKPolarity_20;
extern uint8_t qi_FSKDepth_20;
extern uint8_t qi_recevied_20;
extern uint8_t qi_FSKReserved_20;

extern uint8_t qi_guaranteed_class;
extern uint8_t qi_guaranteed_reserved;
extern uint8_t qi_guaranteed_power;
extern uint8_t qi_potential_class;
extern uint8_t qi_potential_power;
...
extern uint8_t qi_extended_device_identifier[8];         
extern int qi_packet_first_bit_timer_ms;                 
extern int qi_packet_last_bit_timer_ms;                  
...
extern int qi_comm_message_received;                     
extern uint8_t qi_last_packet_header;                    
extern uint8_t qi_tx_last_packet_header; 
extern uint8_t qi_tx_received_power_header;
extern uint8_t qi_message_length;                        
extern uint8_t neg_change_count;
extern fix16_t qi_coil_current_f16;                      
extern fix16_t qi_control_error_value_f16;                

extern uint8_t qi_device_charging;				 
extern uint8_t qi_device_charged;				 
extern int qi_receiving_start_bit_message;                   

extern uint8_t qi_foreign_object_found;                      

extern uint8_t qi_comm_enabled;                              

extern uint8_t voltage_droop_flag;                           


extern uint8_t coil_over_voltage_flag;                           
...
extern int over_current_flag;                            

extern uint8_t efficiency_low_flag;                          

extern uint16_t pwm_duty_ticks;                          

extern fix16_t min_freq_kHz_f16; 

extern int qi_low_power_mode;                            

extern int lp_filter_hys;                                

extern uint8_t dynamic_hysteresis;                           
extern uint8_t collecting_dynamic_hysteresis;                
extern int lp_alpha;                                     

extern int num_comm_errors;                              
...
extern qi_Tx_Power_Contract g_st_power_contract;



extern void WPCQi_TxReset(void);                
extern void qi_state_machine_latch_off(void);            
extern void WPCQiTx_Delay(long ms);              
extern void qi_comm_state_machine_reset(void);           
extern void qi_comm_message_state_machine_reset(void);   
extern void WPCQiTx_WaitPadRemoval(void);      

extern void qi_lp_filter_reset(void);                    
extern void dynamic_hysteresis_reset(void);              
extern __attribute__ ((section(".ramfunc"))) void WPCQi_Tx(void);            
extern __attribute__ ((section(".ramfunc"))) void ASK_vDecode(uint32_t period );       
...
void SYS_vInitSetting ( void )
{
	(*((volatile uint32_t *)(((((uint32_t)0x40000000) + 0x04800UL)+(0x40*(2))) + ((7)<<2))))			= 0;
	(*((volatile uint32_t *)(((((uint32_t)0x40000000) + 0x04800UL)+(0x40*(2))) + ((6)<<2))))		= 0;				
	(*((volatile uint32_t *)(((((uint32_t)0x40000000) + 0x04800UL)+(0x40*(4))) + ((10)<<2))))					= 0;
	(*((volatile uint32_t *)(((((uint32_t)0x40000000) + 0x04800UL)+(0x40*(1))) + ((12)<<2)))) 				= 1;
	(*((volatile uint32_t *)(((((uint32_t)0x40000000) + 0x04800UL)+(0x40*(6))) + ((4)<<2)))) 		= 0; 
	...
	EPWM_EnablePeriodInt(((EPWM_T *) ((((uint32_t)0x40000000) + (uint32_t)0x00040000) + 0x18000UL)), 4, 0); 
...
void CLK_vInit(void)
{
	...
	((GPIO_T *) (((uint32_t)0x40000000) + 0x04140UL))->MODE &= ~((0x3ul << (4)) | (0x3ul << (6)));

	 
	((CLK_T *) (((uint32_t)0x40000000) + 0x00200UL))->PWRCTL |= (0x1ul << (0)); 
	...
	((CLK_T *) (((uint32_t)0x40000000) + 0x00200UL))->PCLKDIV = ((0x0UL << (0)) | (0x0UL << (4)));
	
	 
	CLK_EnableModuleClock(((2UL<<30)|(2UL<<28) |(0x1UL<<25) |(0UL<<20) |(0x0UL<<18)|(0x0UL<<10)|(0x0UL<<5)|(16UL<<0)));
	
	 
	CLK_SetModuleClock(((2UL<<30)|(2UL<<28) |(0x1UL<<25) |(0UL<<20) |(0x0UL<<18)|(0x0UL<<10)|(0x0UL<<5)|(16UL<<0)), (0x0UL << (0)), (uint32_t)0);

	 
	CLK_EnableModuleClock(((2UL<<30)|(2UL<<28) |(0x1UL<<25) |(1UL<<20) |(0x0UL<<18)|(0x0UL<<10)|(0x0UL<<5)|(17UL<<0)));
	
	 
	CLK_SetModuleClock(((2UL<<30)|(2UL<<28) |(0x1UL<<25) |(1UL<<20) |(0x0UL<<18)|(0x0UL<<10)|(0x0UL<<5)|(17UL<<0)), (0x0UL << (1)), (uint32_t)0);


	  	 
	CLK_EnableModuleClock(((2UL<<30)|(0x0UL<<28)|(0x0UL<<25)|(0x0UL<<20)|(0x0UL<<18)|(0x0UL<<10)|(0x0UL<<5)|(26UL<<0)));
	...
	CLK_SetModuleClock(((1UL<<30)|(1UL<<28) |(0x7UL<<25) |(12UL<<20) |(0x0UL<<18)|(0x0UL<<10)|(0x0UL<<5)|(3UL<<0)), (0x2UL << (12)), 0);
	...
	((CLK_T *) (((uint32_t)0x40000000) + 0x00200UL))->APBCLK0 |= (((CLK_T *) (((uint32_t)0x40000000) + 0x00200UL))->APBCLK0 & ~ (0x1ul << (16)) ) | (0x1ul << (16));   
	((CLK_T *) (((uint32_t)0x40000000) + 0x00200UL))->APBCLK0 |= (((CLK_T *) (((uint32_t)0x40000000) + 0x00200UL))->APBCLK0 & ~ (0x1ul << (20)) ) | (0x1ul << (20));	 

     
    
  ((CLK_T *) (((uint32_t)0x40000000) + 0x00200UL))->CLKSEL1 = (((CLK_T *) (((uint32_t)0x40000000) + 0x00200UL))->CLKSEL1 & ~(0x3ul << (24))) | (0x0 << (24));

     
    
	((CLK_T *) (((uint32_t)0x40000000) + 0x00200UL))->CLKSEL3 = (((CLK_T *) (((uint32_t)0x40000000) + 0x00200UL))->CLKSEL3 & ~(0x3ul << (28))) | (0x0 << (28));
	...
	CLK_SetModuleClock(((1UL<<30)|(0x0UL<<28)|(0x0UL<<25)|(0x0UL<<20)|(0UL<<18) |(0xFFUL<<10) |(16UL<<5) |(28UL<<0)), 0, (((1) - 1UL) << (16)));
...
void GPIO_vInit(void)
{
	...
	((SYS_T *) (((uint32_t)0x40000000) + 0x00000UL))->GPA_MFPL &= ~((0xful << (20)) | (0xful << (16)) | (0xful << (12)) | (0xful << (8)) | (0xful << (4)) | (0xful << (0)));
	((SYS_T *) (((uint32_t)0x40000000) + 0x00000UL))->GPA_MFPL |= (  (0x0DUL<<(4)) | (0x0DUL<<(0)));
	((SYS_T *) (((uint32_t)0x40000000) + 0x00000UL))->GPA_MFPL |= ( (0x0DUL<<(8)) | (0x0DUL<<(12)) );
	GPIO_SetMode(((GPIO_T *) (((uint32_t)0x40000000) + 0x04000UL)), (0x00000010UL), 0x1UL); 	 
	GPIO_SetMode(((GPIO_T *) (((uint32_t)0x40000000) + 0x04000UL)), (0x00000020UL), 0x1UL); 	 

 
	((SYS_T *) (((uint32_t)0x40000000) + 0x00000UL))->GPC_MFPL &= ~((0xful << (20)) | (0xful << (16)) | (0xful << (12)) | (0xful << (8)) | (0xful << (4)) | (0xful << (0)) ); 	 
	((SYS_T *) (((uint32_t)0x40000000) + 0x00000UL))->GPC_MFPL |= (   (0x0CUL<<(4))| (0x0CUL<<(0)));

	GPIO_SetMode(((GPIO_T *) (((uint32_t)0x40000000) + 0x04080UL)), (0x00000004UL), 0x1UL); 	 
	GPIO_SetMode(((GPIO_T *) (((uint32_t)0x40000000) + 0x04080UL)), (0x00000008UL), 0x1UL); 	 
	GPIO_SetMode(((GPIO_T *) (((uint32_t)0x40000000) + 0x04080UL)), (0x00000010UL), 0x1UL); 	 
	GPIO_SetMode(((GPIO_T *) (((uint32_t)0x40000000) + 0x04080UL)), (0x00000020UL), 0x1UL); 	

 

	 
	((SYS_T *) (((uint32_t)0x40000000) + 0x00000UL))->GPA_MFPL &= ~((0xful << (24)) | (0xful << (28)));
	((SYS_T *) (((uint32_t)0x40000000) + 0x00000UL))->GPA_MFPL |= ((0x07UL<<(24)) | (0x07UL<<(28)));
	...
	((SYS_T *) (((uint32_t)0x40000000) + 0x00000UL))->GPA_MFPH &= ~((0xful << (20)) | (0xful << (16)));
	((SYS_T *) (((uint32_t)0x40000000) + 0x00000UL))->GPA_MFPH |= ((0x03UL<<(20)) | (0x03UL<<(16)));
...
#line 201 "..\\hardware.c"
	...
	GPIO_SetMode(((GPIO_T *) (((uint32_t)0x40000000) + 0x04140UL)), (0x00000080UL), 0x1UL);    
	GPIO_SetMode(((GPIO_T *) (((uint32_t)0x40000000) + 0x04140UL)), (0x00000100UL), 0x1UL);    
	GPIO_SetMode(((GPIO_T *) (((uint32_t)0x40000000) + 0x04140UL)), (0x00000200UL), 0x1UL);    
	(*((volatile uint32_t *)(((((uint32_t)0x40000000) + 0x04800UL)+(0x40*(5))) + ((7)<<2))))=(*((volatile uint32_t *)(((((uint32_t)0x40000000) + 0x04800UL)+(0x40*(5))) + ((8)<<2))))=(*((volatile uint32_t *)(((((uint32_t)0x40000000) + 0x04800UL)+(0x40*(5))) + ((9)<<2))))=0;


 
	GPIO_SetMode(((GPIO_T *) (((uint32_t)0x40000000) + 0x04100UL)), (0x00000008UL), 0x1UL);    
	GPIO_SetMode(((GPIO_T *) (((uint32_t)0x40000000) + 0x04100UL)), (0x00000010UL), 0x1UL);    
	GPIO_SetMode(((GPIO_T *) (((uint32_t)0x40000000) + 0x04100UL)), (0x00000020UL), 0x1UL);    

	GPIO_SetMode(((GPIO_T *) (((uint32_t)0x40000000) + 0x04100UL)), (0x00000400UL), 0x1UL);

	GPIO_SetMode(((GPIO_T *) (((uint32_t)0x40000000) + 0x04140UL)), (0x00000800UL), 0x1UL);
	...
	GPIO_SetMode(((GPIO_T *) (((uint32_t)0x40000000) + 0x04180UL)), (0x00002000UL), 0x1UL);		
	GPIO_SetMode(((GPIO_T *) (((uint32_t)0x40000000) + 0x04180UL)), (0x00004000UL), 0x1UL);		
	GPIO_SetMode(((GPIO_T *) (((uint32_t)0x40000000) + 0x04180UL)), (0x00008000UL), 0x1UL);		

	 
	GPIO_SetMode(((GPIO_T *) (((uint32_t)0x40000000) + 0x04180UL)), (0x00000010UL), 0x1UL);		

	 
	GPIO_SetMode(((GPIO_T *) (((uint32_t)0x40000000) + 0x041C0UL)), (0x00000100UL), 0x1UL);    
	GPIO_SetMode(((GPIO_T *) (((uint32_t)0x40000000) + 0x041C0UL)), (0x00000200UL), 0x1UL);    
	GPIO_SetMode(((GPIO_T *) (((uint32_t)0x40000000) + 0x041C0UL)), (0x00000400UL), 0x1UL);    
	GPIO_SetMode(((GPIO_T *) (((uint32_t)0x40000000) + 0x041C0UL)), (0x00000800UL), 0x1UL);    
	...
	GPIO_SetMode(((GPIO_T *) (((uint32_t)0x40000000) + 0x04040UL)), (0x00001000UL), 0x1UL);    


	 
	((GPIO_T *) (((uint32_t)0x40000000) + 0x04040UL))->MODE &= ~((0x3ul << (0)) | (0x3ul << (2)) | (0x3ul << (4)) | (0x3ul << (6)) |								(0x3ul << (8)) | (0x3ul << (10)) | (0x3ul << (12)) | (0x3ul << (14)) |								(0x3ul << (16)) | (0x3ul << (18)) | (0x3ul << (20)) | (0x3ul << (22)) );



	GPIO_SetMode(((GPIO_T *) (((uint32_t)0x40000000) + 0x04040UL)), (0x00000100UL), 0x0UL);    
	GPIO_SetMode(((GPIO_T *) (((uint32_t)0x40000000) + 0x04040UL)), (0x00000200UL), 0x0UL);    


	     
	((SYS_T *) (((uint32_t)0x40000000) + 0x00000UL))->GPB_MFPL &= ~((0xful << (0)) | (0xful << (4)) | 											(0xful << (8)) | (0xful << (12)) | 											(0xful << (16)) | (0xful << (20)) | 											(0xful << (24)) | (0xful << (28)) | 											(0xful << (0)) | (0xful << (4)) | 											(0xful << (8)) | (0xful << (12)) );    
	...
	((SYS_T *) (((uint32_t)0x40000000) + 0x00000UL))->GPB_MFPL |= ((0x01UL<<(0)) | (0x01UL<<(4)) | 										(0x01UL<<(8)) | (0x01UL<<(12)) | 										(0x01UL<<(16)) | (0x01UL<<(20)) | 										(0x01UL<<(24)) | (0x01UL<<(28)) | 										(0x01UL<<(0)) | (0x01UL<<(4)) | 										(0x01UL<<(8)) | (0x01UL<<(12)) );
	...
	((((GPIO_T *) (((uint32_t)0x40000000) + 0x04040UL)))->DINOFF |= (((0x00000001UL)|(0x00000002UL)|(0x00000004UL)|(0x00000008UL)|(0x00000010UL)|(0x00000020UL)|(0x00000040UL)|(0x00000080UL)| (0x00000100UL)|(0x00000200UL)|(0x00000400UL)|(0x00000800UL))<<16));
	...
	((SYS_T *) (((uint32_t)0x40000000) + 0x00000UL))->GPE_MFPH = (((SYS_T *) (((uint32_t)0x40000000) + 0x00000UL))->GPE_MFPH & ~(0xful << (0))) | (0x0CUL<<(0));
...
void UART4_vInit(void)
{
	...
	SYS_ResetModule(((4UL<<24) | (20)));

    UART_Open(((UART_T *) ((((uint32_t)0x40000000) + (uint32_t)0x00040000) + 0x34000UL)), 115200);

	    
	((UART_T *) ((((uint32_t)0x40000000) + (uint32_t)0x00040000) + 0x34000UL))->FIFO = (((UART_T *) ((((uint32_t)0x40000000) + (uint32_t)0x00040000) + 0x34000UL))->FIFO &~ (0xful << (4))) | (0x2ul << (4));
         
	UART_SetTimeoutCnt(((UART_T *) ((((uint32_t)0x40000000) + (uint32_t)0x00040000) + 0x34000UL)), 0x3E);    
	     
	UART_EnableInt(((UART_T *) ((((uint32_t)0x40000000) + (uint32_t)0x00040000) + 0x34000UL)), (0x1ul << (0))  
									 );  
}
...
void UART0_vInit(void)
{
	...
	((UART_T *) ((((uint32_t)0x40000000) + (uint32_t)0x00040000) + 0x30000UL))->FIFO = (((UART_T *) ((((uint32_t)0x40000000) + (uint32_t)0x00040000) + 0x30000UL))->FIFO &~ (0xful << (4))) | (0x2ul << (4));		
	((UART_T *) ((((uint32_t)0x40000000) + (uint32_t)0x00040000) + 0x30000UL))->FIFO |= (0x2ul << (16)); 	 

	  	 
	UART_SetTimeoutCnt(((UART_T *) ((((uint32_t)0x40000000) + (uint32_t)0x00040000) + 0x30000UL)), 0x3E); 	 

	 		
	UART_EnableInt(((UART_T *) ((((uint32_t)0x40000000) + (uint32_t)0x00040000) + 0x30000UL)), (0x1ul << (0))   |
									(0x1ul << (4)) | (0x1ul << (11)));		
...
{			   
		...
		EPWM_ConfigOutputChannel(((EPWM_T *) ((((uint32_t)0x40000000) + (uint32_t)0x00040000) + 0x18000UL)), 2, 240000, 50);  
		EPWM_ConfigOutputChannel(((EPWM_T *) ((((uint32_t)0x40000000) + (uint32_t)0x00040000) + 0x18000UL)), 3, 240000, 50);  
    	EPWM_ConfigOutputChannel(((EPWM_T *) ((((uint32_t)0x40000000) + (uint32_t)0x00040000) + 0x18000UL)), 4, 240000, 50);
   		EPWM_ConfigOutputChannel(((EPWM_T *) ((((uint32_t)0x40000000) + (uint32_t)0x00040000) + 0x19000UL)), 4, 240000, 50);
         
		((((EPWM_T *) ((((uint32_t)0x40000000) + (uint32_t)0x00040000) + 0x18000UL)))->PERIOD[(4)] = (872));	
		((((EPWM_T *) ((((uint32_t)0x40000000) + (uint32_t)0x00040000) + 0x18000UL)))->CMPDAT[(4)]= (872- 872/2)); 

		((((EPWM_T *) ((((uint32_t)0x40000000) + (uint32_t)0x00040000) + 0x18000UL)))->PERIOD[(5)] = (872));
		((((EPWM_T *) ((((uint32_t)0x40000000) + (uint32_t)0x00040000) + 0x18000UL)))->CMPDAT[(5)]= (872 - 872/2));  

		((((EPWM_T *) ((((uint32_t)0x40000000) + (uint32_t)0x00040000) + 0x19000UL)))->PERIOD[(4)] = (872));	
		((((EPWM_T *) ((((uint32_t)0x40000000) + (uint32_t)0x00040000) + 0x19000UL)))->CMPDAT[(4)]= (872 - 872/2)); 

		((((EPWM_T *) ((((uint32_t)0x40000000) + (uint32_t)0x00040000) + 0x19000UL)))->PERIOD[(5)] = (872));
		((((EPWM_T *) ((((uint32_t)0x40000000) + (uint32_t)0x00040000) + 0x19000UL)))->CMPDAT[(5)]= (872 - 872/2));  
		
		do{ int i; for(i = 0; i < 6; i++) { if(((0x10U) | (0x20U)) & (1 << i)) (((EPWM_T *) ((((uint32_t)0x40000000) + (uint32_t)0x00040000) + 0x18000UL)))->CTL1 = (((((EPWM_T *) ((((uint32_t)0x40000000) + (uint32_t)0x00040000) + 0x18000UL)))->CTL1 & ~(3UL << (i << 1))) | (((2U)) << (i << 1))); } }while(0);
		do{ int i; for(i = 0; i < 6; i++) { if(((0x10U) | (0x20U)) & (1 << i)) (((EPWM_T *) ((((uint32_t)0x40000000) + (uint32_t)0x00040000) + 0x19000UL)))->CTL1 = (((((EPWM_T *) ((((uint32_t)0x40000000) + (uint32_t)0x00040000) + 0x19000UL)))->CTL1 & ~(3UL << (i << 1))) | (((2U)) << (i << 1))); } }while(0);
         
		do{ int i; for(i = 0; i < 6; i++) { if(((0x10U)) & (1 << i)) { (((EPWM_T *) ((((uint32_t)0x40000000) + (uint32_t)0x00040000) + 0x18000UL)))->WGCTL0 = (((((EPWM_T *) ((((uint32_t)0x40000000) + (uint32_t)0x00040000) + 0x18000UL)))->WGCTL0 & ~(3UL << (i << 1))) | (((1U)) << (i << 1))); (((EPWM_T *) ((((uint32_t)0x40000000) + (uint32_t)0x00040000) + 0x18000UL)))->WGCTL0 = (((((EPWM_T *) ((((uint32_t)0x40000000) + (uint32_t)0x00040000) + 0x18000UL)))->WGCTL0 & ~(3UL << ((16) + (i << 1)))) | (((0U)) << ((16) + (i << 1)))); (((EPWM_T *) ((((uint32_t)0x40000000) + (uint32_t)0x00040000) + 0x18000UL)))->WGCTL1 = (((((EPWM_T *) ((((uint32_t)0x40000000) + (uint32_t)0x00040000) + 0x18000UL)))->WGCTL1 & ~(3UL << (i << 1))) | (((2U)) << (i << 1))); (((EPWM_T *) ((((uint32_t)0x40000000) + (uint32_t)0x00040000) + 0x18000UL)))->WGCTL1 = (((((EPWM_T *) ((((uint32_t)0x40000000) + (uint32_t)0x00040000) + 0x18000UL)))->WGCTL1 & ~(3UL << ((16) + (i << 1)))) | (((0U)) << ((16) + (i << 1)))); } } }while(0);  
		do{ int i; for(i = 0; i < 6; i++) { if(((0x20U)) & (1 << i)) { (((EPWM_T *) ((((uint32_t)0x40000000) + (uint32_t)0x00040000) + 0x18000UL)))->WGCTL0 = (((((EPWM_T *) ((((uint32_t)0x40000000) + (uint32_t)0x00040000) + 0x18000UL)))->WGCTL0 & ~(3UL << (i << 1))) | (((1U)) << (i << 1))); (((EPWM_T *) ((((uint32_t)0x40000000) + (uint32_t)0x00040000) + 0x18000UL)))->WGCTL0 = (((((EPWM_T *) ((((uint32_t)0x40000000) + (uint32_t)0x00040000) + 0x18000UL)))->WGCTL0 & ~(3UL << ((16) + (i << 1)))) | (((0U)) << ((16) + (i << 1)))); (((EPWM_T *) ((((uint32_t)0x40000000) + (uint32_t)0x00040000) + 0x18000UL)))->WGCTL1 = (((((EPWM_T *) ((((uint32_t)0x40000000) + (uint32_t)0x00040000) + 0x18000UL)))->WGCTL1 & ~(3UL << (i << 1))) | (((0U)) << (i << 1))); (((EPWM_T *) ((((uint32_t)0x40000000) + (uint32_t)0x00040000) + 0x18000UL)))->WGCTL1 = (((((EPWM_T *) ((((uint32_t)0x40000000) + (uint32_t)0x00040000) + 0x18000UL)))->WGCTL1 & ~(3UL << ((16) + (i << 1)))) | (((1U)) << ((16) + (i << 1)))); } } }while(0); 

		do{ int i; for(i = 0; i < 6; i++) { if(((0x10U)) & (1 << i)) { (((EPWM_T *) ((((uint32_t)0x40000000) + (uint32_t)0x00040000) + 0x19000UL)))->WGCTL0 = (((((EPWM_T *) ((((uint32_t)0x40000000) + (uint32_t)0x00040000) + 0x19000UL)))->WGCTL0 & ~(3UL << (i << 1))) | (((1U)) << (i << 1))); (((EPWM_T *) ((((uint32_t)0x40000000) + (uint32_t)0x00040000) + 0x19000UL)))->WGCTL0 = (((((EPWM_T *) ((((uint32_t)0x40000000) + (uint32_t)0x00040000) + 0x19000UL)))->WGCTL0 & ~(3UL << ((16) + (i << 1)))) | (((0U)) << ((16) + (i << 1)))); (((EPWM_T *) ((((uint32_t)0x40000000) + (uint32_t)0x00040000) + 0x19000UL)))->WGCTL1 = (((((EPWM_T *) ((((uint32_t)0x40000000) + (uint32_t)0x00040000) + 0x19000UL)))->WGCTL1 & ~(3UL << (i << 1))) | (((2U)) << (i << 1))); (((EPWM_T *) ((((uint32_t)0x40000000) + (uint32_t)0x00040000) + 0x19000UL)))->WGCTL1 = (((((EPWM_T *) ((((uint32_t)0x40000000) + (uint32_t)0x00040000) + 0x19000UL)))->WGCTL1 & ~(3UL << ((16) + (i << 1)))) | (((0U)) << ((16) + (i << 1)))); } } }while(0);  
		do{ int i; for(i = 0; i < 6; i++) { if(((0x20U)) & (1 << i)) { (((EPWM_T *) ((((uint32_t)0x40000000) + (uint32_t)0x00040000) + 0x19000UL)))->WGCTL0 = (((((EPWM_T *) ((((uint32_t)0x40000000) + (uint32_t)0x00040000) + 0x19000UL)))->WGCTL0 & ~(3UL << (i << 1))) | (((1U)) << (i << 1))); (((EPWM_T *) ((((uint32_t)0x40000000) + (uint32_t)0x00040000) + 0x19000UL)))->WGCTL0 = (((((EPWM_T *) ((((uint32_t)0x40000000) + (uint32_t)0x00040000) + 0x19000UL)))->WGCTL0 & ~(3UL << ((16) + (i << 1)))) | (((0U)) << ((16) + (i << 1)))); (((EPWM_T *) ((((uint32_t)0x40000000) + (uint32_t)0x00040000) + 0x19000UL)))->WGCTL1 = (((((EPWM_T *) ((((uint32_t)0x40000000) + (uint32_t)0x00040000) + 0x19000UL)))->WGCTL1 & ~(3UL << (i << 1))) | (((0U)) << (i << 1))); (((EPWM_T *) ((((uint32_t)0x40000000) + (uint32_t)0x00040000) + 0x19000UL)))->WGCTL1 = (((((EPWM_T *) ((((uint32_t)0x40000000) + (uint32_t)0x00040000) + 0x19000UL)))->WGCTL1 & ~(3UL << ((16) + (i << 1)))) | (((1U)) << ((16) + (i << 1)))); } } }while(0); 

         
		((((EPWM_T *) ((((uint32_t)0x40000000) + (uint32_t)0x00040000) + 0x18000UL)))->CTL1 = (((EPWM_T *) ((((uint32_t)0x40000000) + (uint32_t)0x00040000) + 0x18000UL)))->CTL1 | (0x7ul<<(24)));
		((((EPWM_T *) ((((uint32_t)0x40000000) + (uint32_t)0x00040000) + 0x19000UL)))->CTL1 = (((EPWM_T *) ((((uint32_t)0x40000000) + (uint32_t)0x00040000) + 0x19000UL)))->CTL1 | (0x7ul<<(24)));

		 
		((((EPWM_T *) ((((uint32_t)0x40000000) + (uint32_t)0x00040000) + 0x18000UL)))->SSCTL = ((((EPWM_T *) ((((uint32_t)0x40000000) + (uint32_t)0x00040000) + 0x18000UL)))->SSCTL & ~(0x3ul << (8))) | ((0U<<(8))) | ((0x10U) | (0x20U)));
		((((EPWM_T *) ((((uint32_t)0x40000000) + (uint32_t)0x00040000) + 0x19000UL)))->SSCTL = ((((EPWM_T *) ((((uint32_t)0x40000000) + (uint32_t)0x00040000) + 0x19000UL)))->SSCTL & ~(0x3ul << (8))) | ((1U<<(8))) | ((0x10U) | (0x20U)));

         
		((((EPWM_T *) ((((uint32_t)0x40000000) + (uint32_t)0x00040000) + 0x19000UL)))->POLCTL = ((0x10U) | (0x20U)));


         
		((((EPWM_T *) ((((uint32_t)0x40000000) + (uint32_t)0x00040000) + 0x18000UL)))->PERIOD[(2)] = (800));	
		((((EPWM_T *) ((((uint32_t)0x40000000) + (uint32_t)0x00040000) + 0x18000UL)))->CMPDAT[(2)]= (800/2)); 
		
		((((EPWM_T *) ((((uint32_t)0x40000000) + (uint32_t)0x00040000) + 0x18000UL)))->PERIOD[(3)] = (800));	
		((((EPWM_T *) ((((uint32_t)0x40000000) + (uint32_t)0x00040000) + 0x18000UL)))->CMPDAT[(3)]= (800/2)); 

		do{ int i; for(i = 0; i < 6; i++) { if(((0x4U)) & (1 << i)) (((EPWM_T *) ((((uint32_t)0x40000000) + (uint32_t)0x00040000) + 0x18000UL)))->CTL1 = (((((EPWM_T *) ((((uint32_t)0x40000000) + (uint32_t)0x00040000) + 0x18000UL)))->CTL1 & ~(3UL << (i << 1))) | (((2U)) << (i << 1))); } }while(0);
		do{ int i; for(i = 0; i < 6; i++) { if(((0x8U)) & (1 << i)) (((EPWM_T *) ((((uint32_t)0x40000000) + (uint32_t)0x00040000) + 0x18000UL)))->CTL1 = (((((EPWM_T *) ((((uint32_t)0x40000000) + (uint32_t)0x00040000) + 0x18000UL)))->CTL1 & ~(3UL << (i << 1))) | (((2U)) << (i << 1))); } }while(0);

		do{ int i; for(i = 0; i < 6; i++) { if(((0x4U)) & (1 << i)) { (((EPWM_T *) ((((uint32_t)0x40000000) + (uint32_t)0x00040000) + 0x18000UL)))->WGCTL0 = (((((EPWM_T *) ((((uint32_t)0x40000000) + (uint32_t)0x00040000) + 0x18000UL)))->WGCTL0 & ~(3UL << (i << 1))) | (((1U)) << (i << 1))); (((EPWM_T *) ((((uint32_t)0x40000000) + (uint32_t)0x00040000) + 0x18000UL)))->WGCTL0 = (((((EPWM_T *) ((((uint32_t)0x40000000) + (uint32_t)0x00040000) + 0x18000UL)))->WGCTL0 & ~(3UL << ((16) + (i << 1)))) | (((0U)) << ((16) + (i << 1)))); (((EPWM_T *) ((((uint32_t)0x40000000) + (uint32_t)0x00040000) + 0x18000UL)))->WGCTL1 = (((((EPWM_T *) ((((uint32_t)0x40000000) + (uint32_t)0x00040000) + 0x18000UL)))->WGCTL1 & ~(3UL << (i << 1))) | (((2U)) << (i << 1))); (((EPWM_T *) ((((uint32_t)0x40000000) + (uint32_t)0x00040000) + 0x18000UL)))->WGCTL1 = (((((EPWM_T *) ((((uint32_t)0x40000000) + (uint32_t)0x00040000) + 0x18000UL)))->WGCTL1 & ~(3UL << ((16) + (i << 1)))) | (((1U)) << ((16) + (i << 1)))); } } }while(0);  
		do{ int i; for(i = 0; i < 6; i++) { if(((0x8U)) & (1 << i)) { (((EPWM_T *) ((((uint32_t)0x40000000) + (uint32_t)0x00040000) + 0x18000UL)))->WGCTL0 = (((((EPWM_T *) ((((uint32_t)0x40000000) + (uint32_t)0x00040000) + 0x18000UL)))->WGCTL0 & ~(3UL << (i << 1))) | (((1U)) << (i << 1))); (((EPWM_T *) ((((uint32_t)0x40000000) + (uint32_t)0x00040000) + 0x18000UL)))->WGCTL0 = (((((EPWM_T *) ((((uint32_t)0x40000000) + (uint32_t)0x00040000) + 0x18000UL)))->WGCTL0 & ~(3UL << ((16) + (i << 1)))) | (((0U)) << ((16) + (i << 1)))); (((EPWM_T *) ((((uint32_t)0x40000000) + (uint32_t)0x00040000) + 0x18000UL)))->WGCTL1 = (((((EPWM_T *) ((((uint32_t)0x40000000) + (uint32_t)0x00040000) + 0x18000UL)))->WGCTL1 & ~(3UL << (i << 1))) | (((2U)) << (i << 1))); (((EPWM_T *) ((((uint32_t)0x40000000) + (uint32_t)0x00040000) + 0x18000UL)))->WGCTL1 = (((((EPWM_T *) ((((uint32_t)0x40000000) + (uint32_t)0x00040000) + 0x18000UL)))->WGCTL1 & ~(3UL << ((16) + (i << 1)))) | (((1U)) << ((16) + (i << 1)))); } } }while(0); 

		SYS_UnlockReg();			

		EPWM_EnableDeadZone(((EPWM_T *) ((((uint32_t)0x40000000) + (uint32_t)0x00040000) + 0x18000UL)), 4, 0x9);		
		EPWM_EnableDeadZone(((EPWM_T *) ((((uint32_t)0x40000000) + (uint32_t)0x00040000) + 0x19000UL)), 4, 0x9);		
		SYS_LockReg();


		EPWM_EnableOutput(((EPWM_T *) ((((uint32_t)0x40000000) + (uint32_t)0x00040000) + 0x18000UL)),   (0x8U) | (0x10U) | (0x20U) );
        EPWM_EnableOutput(((EPWM_T *) ((((uint32_t)0x40000000) + (uint32_t)0x00040000) + 0x19000UL)),   (0x10U) | (0x20U) );

		(*((volatile uint32_t *)(((((uint32_t)0x40000000) + 0x04800UL)+(0x40*(0))) + ((3)<<2))))=(*((volatile uint32_t *)(((((uint32_t)0x40000000) + 0x04800UL)+(0x40*(0))) + ((4)<<2))))=(*((volatile uint32_t *)(((((uint32_t)0x40000000) + 0x04800UL)+(0x40*(0))) + ((5)<<2))))=1; 	 
		(*((volatile uint32_t *)(((((uint32_t)0x40000000) + 0x04800UL)+(0x40*(2))) + ((2)<<2))))=(*((volatile uint32_t *)(((((uint32_t)0x40000000) + 0x04800UL)+(0x40*(2))) + ((3)<<2))))=(*((volatile uint32_t *)(((((uint32_t)0x40000000) + 0x04800UL)+(0x40*(2))) + ((4)<<2))))=(*((volatile uint32_t *)(((((uint32_t)0x40000000) + 0x04800UL)+(0x40*(2))) + ((5)<<2))))=1; 	 

		
		EPWM_Start(((EPWM_T *) ((((uint32_t)0x40000000) + (uint32_t)0x00040000) + 0x18000UL)),   (0x4U) | (0x8U) | (0x10U) | (0x20U) );
		EPWM_Start(((EPWM_T *) ((((uint32_t)0x40000000) + (uint32_t)0x00040000) + 0x19000UL)),   (0x10U) | (0x20U) );
...
void ECAP0_vInit(void)
{
	...
	((((ECAP_T *) ((((uint32_t)0x40000000) + (uint32_t)0x00040000) + 0x74000UL)))->CNTCMP = (34000)); 

	 
	ECAP_Open(((ECAP_T *) ((((uint32_t)0x40000000) + (uint32_t)0x00040000) + 0x74000UL)), (1UL<<(28))  );		

     
	((((ECAP_T *) ((((uint32_t)0x40000000) + (uint32_t)0x00040000) + 0x74000UL)))->CTL0 = ((((ECAP_T *) ((((uint32_t)0x40000000) + (uint32_t)0x00040000) + 0x74000UL)))->CTL0 & ~(0x7ul << (0)))|((1UL<<(0))));  

	 		
	((((ECAP_T *) ((((uint32_t)0x40000000) + (uint32_t)0x00040000) + 0x74000UL)))->CTL0 |= ((0x1ul << (4))));

	 		
	((((ECAP_T *) ((((uint32_t)0x40000000) + (uint32_t)0x00040000) + 0x74000UL)))->CTL0 = ((((ECAP_T *) ((((uint32_t)0x40000000) + (uint32_t)0x00040000) + 0x74000UL)))->CTL0 & ~((0x3ul << (8))<<(((0UL))<<1)))|((((0UL))<<(8))<<(((0UL))<<1)));

	((ECAP_T *) ((((uint32_t)0x40000000) + (uint32_t)0x00040000) + 0x74000UL))->CTL0 |= (0x1ul << (16));

	((((ECAP_T *) ((((uint32_t)0x40000000) + (uint32_t)0x00040000) + 0x74000UL)))->CTL0 |= (0x1ul << (21)));	

	((ECAP_T *) ((((uint32_t)0x40000000) + (uint32_t)0x00040000) + 0x74000UL))->CTL0 |= (0x1ul << (25));

	((((ECAP_T *) ((((uint32_t)0x40000000) + (uint32_t)0x00040000) + 0x74000UL)))->CTL0 |= (0x1ul << (28)));	
	
	((((ECAP_T *) ((((uint32_t)0x40000000) + (uint32_t)0x00040000) + 0x74000UL)))->CTL0 |= (0x1ul << (29))); 

	  	 
	((((ECAP_T *) ((((uint32_t)0x40000000) + (uint32_t)0x00040000) + 0x74000UL)))->CTL1 = ((((ECAP_T *) ((((uint32_t)0x40000000) + (uint32_t)0x00040000) + 0x74000UL)))->CTL1 & ~((0x3ul << (0))<<(((0UL))<<1)))|(((2UL<<(0)))<<(((0UL))<<1)));	

     
	((((ECAP_T *) ((((uint32_t)0x40000000) + (uint32_t)0x00040000) + 0x74000UL)))->CTL1 = ((((ECAP_T *) ((((uint32_t)0x40000000) + (uint32_t)0x00040000) + 0x74000UL)))->CTL1 & ~(0x7ul << (12)))|((1UL<<(12))));
	
	 		
	do{ if((((0x1ul << (8)) )) & (0x1ul << (25))) (((ECAP_T *) ((((uint32_t)0x40000000) + (uint32_t)0x00040000) + 0x74000UL)))->CTL0 |= (0x1ul << (25)); else (((ECAP_T *) ((((uint32_t)0x40000000) + (uint32_t)0x00040000) + 0x74000UL)))->CTL0 &= ~(0x1ul << (25)); (((ECAP_T *) ((((uint32_t)0x40000000) + (uint32_t)0x00040000) + 0x74000UL)))->CTL1 = ((((ECAP_T *) ((((uint32_t)0x40000000) + (uint32_t)0x00040000) + 0x74000UL)))->CTL1 &~0xF00) | ((((0x1ul << (8)) )) & 0xF00); }while(0);;

	((ECAP_T *) ((((uint32_t)0x40000000) + (uint32_t)0x00040000) + 0x74000UL))->CTL0 |= (0x1ul << (25));


	 		
	((((ECAP_T *) ((((uint32_t)0x40000000) + (uint32_t)0x00040000) + 0x74000UL)))->STATUS = ((0x1ul << (0)) | (0x1ul << (4)) | (0x1ul << (5)))); 
...
void ECAP0_vStart(void)
{
	...
	((((ECAP_T *) ((((uint32_t)0x40000000) + (uint32_t)0x00040000) + 0x74000UL)))->CTL0 |= (0x1ul << (24)));  
}
...
void TMR1_vInit(void)
{
	...
	TIMER_Open(((TIMER_T *) ((((uint32_t)0x40000000) + (uint32_t)0x00040000) + 0x10100UL)), (1UL << (27)) , 400);	
	
	((((TIMER_T *) ((((uint32_t)0x40000000) + (uint32_t)0x00040000) + 0x10100UL)))->CTL = ((((TIMER_T *) ((((uint32_t)0x40000000) + (uint32_t)0x00040000) + 0x10100UL)))->CTL & ~(0xfful << (0))) | (31));		
	
	((((TIMER_T *) ((((uint32_t)0x40000000) + (uint32_t)0x00040000) + 0x10100UL)))->CMP = (6000));		
...
void ADC_vInit(void)
{
  ...
  ((((GPIO_T *) (((uint32_t)0x40000000) + 0x04040UL)))->DINOFF |= (((0x00000001UL))<<16));
	 						
	EADC_ConfigSampleModule(((EADC_T *) ((((uint32_t)0x40000000) + (uint32_t)0x00040000) + 0x03000UL)), 0, (2UL<<(16)), 0); 					 
	
   
  ((((GPIO_T *) (((uint32_t)0x40000000) + 0x04040UL)))->DINOFF |= (((0x00000002UL))<<16));
	 						
	EADC_ConfigSampleModule(((EADC_T *) ((((uint32_t)0x40000000) + (uint32_t)0x00040000) + 0x03000UL)), 1, (2UL<<(16)), 1); 					 
	
   
  ((((GPIO_T *) (((uint32_t)0x40000000) + 0x04040UL)))->DINOFF |= (((0x00000004UL))<<16));
	 						
	EADC_ConfigSampleModule(((EADC_T *) ((((uint32_t)0x40000000) + (uint32_t)0x00040000) + 0x03000UL)), 2, (2UL<<(16)), 2); 					 
	
   
  ((((GPIO_T *) (((uint32_t)0x40000000) + 0x04040UL)))->DINOFF |= (((0x00000008UL))<<16));
	 						
	EADC_ConfigSampleModule(((EADC_T *) ((((uint32_t)0x40000000) + (uint32_t)0x00040000) + 0x03000UL)), 3, (2UL<<(16)), 3);
	
   
  ((((GPIO_T *) (((uint32_t)0x40000000) + 0x04040UL)))->DINOFF |= (((0x00000010UL))<<16));
	 						
	EADC_ConfigSampleModule(((EADC_T *) ((((uint32_t)0x40000000) + (uint32_t)0x00040000) + 0x03000UL)), 4, (2UL<<(16)), 4);
	
   
  ((((GPIO_T *) (((uint32_t)0x40000000) + 0x04040UL)))->DINOFF |= (((0x00000020UL))<<16));
	 						
	EADC_ConfigSampleModule(((EADC_T *) ((((uint32_t)0x40000000) + (uint32_t)0x00040000) + 0x03000UL)), 5, (2UL<<(16)), 5);
	
   
  ((((GPIO_T *) (((uint32_t)0x40000000) + 0x04040UL)))->DINOFF |= (((0x00000040UL))<<16));
	 						
	EADC_ConfigSampleModule(((EADC_T *) ((((uint32_t)0x40000000) + (uint32_t)0x00040000) + 0x03000UL)), 6, (2UL<<(16)), 6);
	
   
  ((((GPIO_T *) (((uint32_t)0x40000000) + 0x04040UL)))->DINOFF |= (((0x00000080UL))<<16));
	 						
	EADC_ConfigSampleModule(((EADC_T *) ((((uint32_t)0x40000000) + (uint32_t)0x00040000) + 0x03000UL)), 7, (2UL<<(16)), 7);
	
   
  ((((GPIO_T *) (((uint32_t)0x40000000) + 0x04040UL)))->DINOFF |= (((0x00000100UL))<<16));
	 						
	EADC_ConfigSampleModule(((EADC_T *) ((((uint32_t)0x40000000) + (uint32_t)0x00040000) + 0x03000UL)), 8, (2UL<<(16)), 8);
	
   
  ((((GPIO_T *) (((uint32_t)0x40000000) + 0x04040UL)))->DINOFF |= (((0x00000200UL))<<16));
	 						
	EADC_ConfigSampleModule(((EADC_T *) ((((uint32_t)0x40000000) + (uint32_t)0x00040000) + 0x03000UL)), 9, (2UL<<(16)), 9);
	
   
  ((((GPIO_T *) (((uint32_t)0x40000000) + 0x04040UL)))->DINOFF |= (((0x00000400UL))<<16));
	 						
	EADC_ConfigSampleModule(((EADC_T *) ((((uint32_t)0x40000000) + (uint32_t)0x00040000) + 0x03000UL)), 10, (2UL<<(16)), 10);
	
   
  ((((GPIO_T *) (((uint32_t)0x40000000) + 0x04040UL)))->DINOFF |= (((0x00000800UL))<<16));
	 						
	EADC_ConfigSampleModule(((EADC_T *) ((((uint32_t)0x40000000) + (uint32_t)0x00040000) + 0x03000UL)), 11, (2UL<<(16)), 11);


               
	((((EADC_T *) ((((uint32_t)0x40000000) + (uint32_t)0x00040000) + 0x03000UL)))->STATUS2 = ((0x1ul << (0))));
